import{n as e}from"./chunk-BneVvdWh.js";import{X as t,i as n}from"./iframe-CuxZAc4v.js";import{c as r,l as i,s as a,t as o,u as s}from"./components-De-VN3a5.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{o(),s(),n(),{expect:c,fireEvent:l,userEvent:u,waitFor:d,within:f}=__STORYBOOK_MODULE_TEST__,p={page:`
    display: flex;
  ...
  `,divider:`height: 1px; background: #e5e7eb; margin: 0.25rem 0;`},m={title:`Data Display/Tour`,component:a,tags:[`autodocs`],argTypes:{open:{control:`boolean`,description:`Controlled open state.`,table:{category:`Two-Way Binding Props`}},current:{control:`number`,description:`Controlled current step index.`,table:{category:`Two-Way Binding Props`}},type:{control:`select`,options:Object.values(i),description:`Visual variant.`},placement:{control:`select`,options:Object.values(r),description:`Default popup placement (step-level overrides).`},mask:{control:`boolean`,description:`Show a mask overlay with spotlight cutout.`},arrow:{control:`boolean`,description:`Show the directional arrow.`},keyboard:{control:`boolean`,description:`Enable keyboard navigation.`},zIndex:{control:`number`,description:`z-index of the popup and mask.`},closeIcon:{control:`boolean`,description:`Show the close button.`},disabledInteraction:{control:`boolean`,description:`Disable pointer interaction on highlighted region.`},onChange:{action:`change`},onClose:{action:`close`},onFinish:{action:`finish`}},parameters:{docs:{description:{component:`The <code>BTour</code> component guides users through a product with step-by-step popups. It supports both controlled and uncontrolled modes, keyboard navigation, SVG spotlight masking, and full dark-mode theming.`}}}},h={args:{open:!1,type:i.Default,placement:r.Bottom,mask:!0,arrow:!0,keyboard:!0,zIndex:1070,closeIcon:!0,disabledInteraction:!1},render:e=>({components:{BTour:a},setup(){return{args:e,isOpen:t(!1),currentStep:t(0),steps:[{title:`New Document`,description:`Create a new file or folder to get started.`,target:()=>document.getElementById(`pg-new`),placement:r.Bottom},{title:`Upload Files`,description:`Drag & drop or click to upload files from your device.`,target:()=>document.getElementById(`pg-upload`),placement:r.Bottom},{title:`Search`,description:`Quickly find any file by name, tag, or content.`,target:()=>document.getElementById(`pg-search`),placement:r.Bottom},{title:`Share & Collaborate`,description:`Invite teammates and control their access level.`,target:()=>document.getElementById(`pg-share`),placement:r.Bottom}]}},template:`
      <div :style="UI.page">
        <!-- Toolbar -->
    ...
    `,data(){return{UI:p}}})},g={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`New Document`,description:`Create a blank document, spreadsheet, or presentation in one click.`,target:()=>document.getElementById(`def-new`),placement:r.Bottom},{title:`Upload Files`,description:`Drag & drop or browse your device to upload files up to 2 GB.`,target:()=>document.getElementById(`def-upload`),placement:r.Bottom},{title:`Filter & Sort`,description:`Narrow results by type, owner, or date modified.`,target:()=>document.getElementById(`def-filter`),placement:r.BottomLeft},{title:`Share`,description:`Invite teammates with view or edit access.`,target:()=>document.getElementById(`def-share`),placement:r.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page">
        <div :style="UI.toolbar">
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Default type with four toolbar targets - New, Upload, Filter, and Share.`}}}},_={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Overview Panel`,description:`Your key metrics at a glance - visits, conversions, and revenue.`,target:()=>document.getElementById(`pri-overview`),placement:r.Bottom,type:i.Primary},{title:`Activity Feed`,description:`A real-time stream of team actions and system events.`,target:()=>document.getElementById(`pri-activity`),placement:r.Left,type:i.Primary},{title:`Quick Actions`,description:`Run frequent tasks without leaving the dashboard.`,target:()=>document.getElementById(`pri-actions`),placement:r.Top,type:i.Primary},{title:`User Menu`,description:`Access your profile, settings, and sign-out options.`,target:()=>document.getElementById(`pri-user`),placement:r.BottomRight,type:i.Primary}],isOpen:e,step:n}},template:`
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Primary type spotlighting four dashboard regions - overview panel, activity feed, quick actions, and user menu.`},source:{code:`<BTour :steps="steps" type="primary" v-model:open="open" v-model:current="current" />`}}}},v=`https://user-images.githubusercontent.com/5378891/197385811-55df8480-7ff4-44bd-9d43-a7dade598d70.png`,y={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Welcome to CloudDrive`,description:`A quick tour of the features that help you store, share, and collaborate.`,cover:v,target:()=>document.getElementById(`cov-logo`),placement:r.BottomLeft},{title:`Your Storage`,description:`See how much space you have used and upgrade at any time.`,cover:v,target:()=>document.getElementById(`cov-storage`),placement:r.Right},{title:`Recent Files`,description:`Jump back into documents you recently opened or edited.`,cover:v,target:()=>document.getElementById(`cov-recent`),placement:r.Top},{title:`Notifications`,description:`Stay informed about comments, shares, and system alerts.`,cover:v,target:()=>document.getElementById(`cov-bell`),placement:r.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <!-- Header -->
        <div style="display:flex; align-items:center; gap:0.75rem; padding:0.5rem 0.75rem; background:#fff; border:1px solid #e5e7eb; border-radius:0.5rem;">
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Each step includes a cover image above the title. The tour spotlights logo, storage bar, recent files, and notifications.`}}}},b={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Profile`,description:`Update your display name, avatar, and contact details.`,target:()=>document.getElementById(`nm-profile`),placement:r.Right},{title:`Notifications`,description:`Choose which events trigger email or push notifications.`,target:()=>document.getElementById(`nm-notif`),placement:r.Right},{title:`Security`,description:`Enable two-factor authentication and review active sessions.`,target:()=>document.getElementById(`nm-security`),placement:r.Right},{title:`Billing`,description:`Manage your subscription, invoices, and payment methods.`,target:()=>document.getElementById(`nm-billing`),placement:r.Right}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:"`mask=false` - the overlay is removed so users can still interact with the page while the tour runs."}}}},x={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Run Code`,description:`Execute the current file and see output in the panel below.`,target:()=>document.getElementById(`wt-run`),placement:r.Bottom},{title:`Format`,description:`Auto-format your code with Prettier on save or on demand.`,target:()=>document.getElementById(`wt-format`),placement:r.Bottom},{title:`Terminal`,description:`Open an integrated terminal pane at the bottom of the editor.`,target:()=>document.getElementById(`wt-terminal`),placement:r.Bottom},{title:`Extensions`,description:`Browse and install plugins to extend editor functionality.`,target:()=>document.getElementById(`wt-ext`),placement:r.BottomRight},{title:`Settings`,description:`Customise keybindings, themes, and editor preferences.`,target:()=>document.getElementById(`wt-settings`),placement:r.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <!-- Editor chrome -->
...
<span style="color:#89b4fa;">const</span> <span style="color:#cba6f7;">count</span> <span style="color:#89dceb;">=</span> <span style="color:#89b4fa;">ref</span>(<span style="color:#fab387;">0</span>)</code></pre>
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Five targeted steps across a code-editor toolbar - Run, Format, Terminal, Extensions, and Settings.`}}}},S={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Cart Summary`,description:`Review your items, quantities, and individual prices here.`,target:()=>document.getElementById(`ci-cart`),placement:r.Left},{title:`Promo Code`,description:`Enter a discount code to reduce your total at checkout.`,target:()=>document.getElementById(`ci-promo`),placement:r.Top},{title:`Shipping Options`,description:`Choose between standard, express, or same-day delivery.`,target:()=>document.getElementById(`ci-shipping`),placement:r.Top},{title:`Place Order`,description:`Confirm your order once you are happy with everything.`,target:()=>document.getElementById(`ci-order`),placement:r.Top}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <div style="display:grid; grid-template-columns:1fr 280px; gap:0.75rem;">
          <!-- Order form -->
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:'The `indicatorsRender` slot replaces dots with a "current / total" counter. Tour targets a checkout page.'}}}},C={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Invite Members`,description:`Add new team members by email and assign them a role.`,target:()=>document.getElementById(`a11y-invite`),placement:r.Bottom},{title:`Role Filter`,description:`Filter the list to show only Admins, Editors, or Viewers.`,target:()=>document.getElementById(`a11y-filter`),placement:r.Bottom},{title:`Bulk Actions`,description:`Select multiple rows then apply actions like Remove or Change Role.`,target:()=>document.getElementById(`a11y-bulk`),placement:r.BottomLeft},{title:`Export`,description:`Download the full member list as a CSV file.`,target:()=>document.getElementById(`a11y-export`),placement:r.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
    ...
    `,data(){return{UI:p}}}),play:async({canvasElement:e})=>{let t=f(e),n=u.setup();c(document.body.querySelector(`.b-tour__popup`)).toBeNull(),await n.click(t.getByRole(`button`,{name:/start accessible tour/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup`)).not.toBeNull());let r=document.body.querySelector(`.b-tour__popup`),i=f(r),a=document.body.querySelector(`[role="dialog"]`);c(a).toBeTruthy(),c(a).toHaveAttribute(`aria-modal`,`true`),c(a).toHaveAttribute(`aria-label`,`Invite Members`),c(i.getByRole(`button`,{name:/close tour/i})).toBeTruthy();let o=i.getByRole(`button`,{name:/next/i});c(o).toBeTruthy();let s=r.querySelector(`.b-tour__indicator--active`);c(s).toBeTruthy(),c(s).toHaveAttribute(`aria-current`,`step`),await n.click(o),await d(()=>c(document.body.querySelector(`[role="dialog"]`)).toHaveAttribute(`aria-label`,`Role Filter`));let p=document.body.querySelector(`.b-tour__popup`),m=p.querySelectorAll(`.b-tour__indicator`);c(m[0]).not.toHaveAttribute(`aria-current`),c(m[1]).toHaveAttribute(`aria-current`,`step`),l.keyDown(p,{key:`Escape`,code:`Escape`,bubbles:!0}),await d(()=>c(document.body.querySelector(`.b-tour__popup`)).toBeNull())},parameters:{docs:{description:{story:"Targets four toolbar controls on a team management table. Interaction test verifies `role`, `aria-modal`, button labels, and `aria-current`."}}}},w={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Date Range`,description:`Select a custom date range to scope all charts and metrics.`,target:()=>document.getElementById(`th-date`),placement:r.Bottom},{title:`KPI Cards`,description:`High-level numbers updated in real time from your data source.`,target:()=>document.getElementById(`th-kpis`),placement:r.Bottom},{title:`Chart Area`,description:`Visualise trends over time. Hover a point to see exact values.`,target:()=>document.getElementById(`th-chart`),placement:r.Top},{title:`Export Report`,description:`Download a PDF or CSV snapshot of the current view.`,target:()=>document.getElementById(`th-export`),placement:r.BottomRight}],isOpen:e,step:n}},template:`
      <div
        style="
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:"Overrides `--b-tour-popup-bg`, `--b-tour-title-color`, `--b-tour-next-btn-bg`, `--b-tour-indicator-active-bg`, and `--b-tour-mask-bg`. Tour targets an analytics dashboard."},source:{code:`<div style="
  --b-tour-popup-bg: oklch(30% 0.05 300);
  --b-tour-title-color: oklch(95% 0.05 300);
  --b-tour-next-btn-bg: oklch(70% 0.2 300);
  --b-tour-indicator-active-bg: oklch(70% 0.2 300);
...
">
  <BTour :steps="steps" v-model:open="open" v-model:current="current" />
</div>`}}}},T={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Upload File`,description:`Put your files here to start the upload process.`,target:()=>document.getElementById(`if-upload`),placement:r.Bottom},{title:`Save to Local Drive`,description:`Save your files to a local drive for backup.`,target:()=>document.getElementById(`if-save`),placement:r.Bottom},{title:`Share`,description:`Share your files with friends and colleagues.`,target:()=>document.getElementById(`if-share`),placement:r.Bottom}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <div :style="UI.toolbar">
    ...
    `,data(){return{UI:p}}}),play:async({canvasElement:e})=>{let t=f(e),n=u.setup();c(document.body.querySelector(`.b-tour__popup`)).toBeNull(),await n.click(t.getByRole(`button`,{name:/start tour/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup`)).not.toBeNull()),await d(()=>c(document.body.querySelector(`.b-tour__popup .b-tour__title`)?.textContent?.trim()).toBe(`Upload File`)),c(document.body.querySelector(`.b-tour__popup .b-tour__btn--prev`)).toBeNull(),await n.click(f(document.body.querySelector(`.b-tour__popup`)).getByRole(`button`,{name:/next/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup .b-tour__title`)?.textContent?.trim()).toBe(`Save to Local Drive`)),c(document.body.querySelector(`.b-tour__popup .b-tour__btn--prev`)).toBeTruthy(),await n.click(f(document.body.querySelector(`.b-tour__popup`)).getByRole(`button`,{name:/next/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup .b-tour__title`)?.textContent?.trim()).toBe(`Share`)),c(document.body.querySelector(`.b-tour__popup .b-tour__btn--next`)?.textContent?.trim()).toBe(`Finish`),await n.click(f(document.body.querySelector(`.b-tour__popup`)).getByRole(`button`,{name:/finish/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup`)).toBeNull())},parameters:{docs:{description:{story:`Automated interaction test: open → step through Upload / Save / Share → Finish → verify closed.`}}}},E=[{token:`--b-tour-close-btn-size`,defaultValue:`22px`,description:`Size of the close button (AntD: closeBtnSize).`},{token:`--b-tour-primary-prev-btn-bg`,defaultValue:`rgba(255, 255, 255, 0.15)`,description:`Background of the previous button in the primary type (AntD: primaryPrevBtnBg).`},{token:`--b-tour-primary-next-btn-hover-bg`,defaultValue:`rgb(240, 240, 240)`,description:`Hover background of the next button in the primary type (AntD: primaryNextBtnHoverBg).`},{token:`--b-tour-z-index`,defaultValue:`1070`,description:`z-index of the tour popup (AntD: zIndexPopup).`},{token:`--b-tour-mask-bg`,defaultValue:`rgba(0, 0, 0, 0.45)`,description:`Background of the highlight mask.`},{token:`--b-tour-popup-bg`,defaultValue:`#fff`,description:`Background of the tour popup.`},{token:`--b-tour-popup-color`,defaultValue:`oklch(25% 0 0)`,description:`Default text color in the tour popup.`},{token:`--b-tour-popup-shadow`,defaultValue:`0 1px 2px 0 oklch(0% 0 0 / 3%), 0 1px 6px -1px oklch(0% 0 0 / 2%)`,description:`Box shadow of the tour popup.`},{token:`--b-tour-popup-border-radius`,defaultValue:`0.5rem`,description:`Corner radius of the tour popup.`},{token:`--b-tour-popup-padding`,defaultValue:`1rem`,description:`Padding inside the tour popup.`},{token:`--b-tour-popup-min-width`,defaultValue:`220px`,description:`Min width of the tour popup.`},{token:`--b-tour-popup-max-width`,defaultValue:`320px`,description:`Max width of the tour popup.`},{token:`--b-tour-popup-font-size`,defaultValue:`0.875rem`,description:`Body font size of the tour popup.`},{token:`--b-tour-popup-line-height`,defaultValue:`1.5`,description:`Body line height of the tour popup.`},{token:`--b-tour-arrow-bg`,defaultValue:`#fff`,description:`Background of the popup arrow (matches popup bg).`},{token:`--b-tour-arrow-size`,defaultValue:`10px`,description:`Arrow size.`},{token:`--b-tour-cover-border-radius`,defaultValue:`0.5rem 0.5rem 0 0`,description:`Corner radius of the cover image area.`},{token:`--b-tour-title-color`,defaultValue:`oklch(15% 0 0)`,description:`Title text color.`},{token:`--b-tour-title-font-size`,defaultValue:`1rem`,description:`Title font size.`},{token:`--b-tour-title-font-weight`,defaultValue:`600`,description:`Title font weight.`},{token:`--b-tour-description-color`,defaultValue:`oklch(35% 0 0)`,description:`Description text color.`},{token:`--b-tour-description-font-size`,defaultValue:`0.875rem`,description:`Description font size.`},{token:`--b-tour-close-color`,defaultValue:`oklch(55% 0 0)`,description:`Color of the close icon.`},{token:`--b-tour-close-hover-color`,defaultValue:`oklch(25% 0 0)`,description:`Hover color of the close icon.`},{token:`--b-tour-indicator-bg`,defaultValue:`oklch(80% 0 0)`,description:`Idle background of step indicator dots.`},{token:`--b-tour-indicator-active-bg`,defaultValue:`oklch(55% 0.169 237.323)`,description:`Active background of the current step indicator.`},{token:`--b-tour-indicator-size`,defaultValue:`6px`,description:`Size of step indicator dots.`},{token:`--b-tour-prev-btn-bg`,defaultValue:`transparent`,description:`Background of the previous button.`},{token:`--b-tour-prev-btn-color`,defaultValue:`oklch(35% 0 0)`,description:`Text color of the previous button.`},{token:`--b-tour-prev-btn-border`,defaultValue:`1px solid oklch(80% 0 0)`,description:`Border of the previous button.`},{token:`--b-tour-prev-btn-hover-bg`,defaultValue:`oklch(96% 0 0)`,description:`Hover background of the previous button.`},{token:`--b-tour-next-btn-bg`,defaultValue:`oklch(55% 0.169 237.323)`,description:`Background of the next/finish button.`},{token:`--b-tour-next-btn-color`,defaultValue:`#fff`,description:`Text color of the next/finish button.`},{token:`--b-tour-next-btn-hover-bg`,defaultValue:`oklch(48% 0.158 241.966)`,description:`Hover background of the next/finish button.`},{token:`--b-tour-btn-padding`,defaultValue:`0.25rem 0.75rem`,description:`Padding inside tour buttons.`},{token:`--b-tour-btn-font-size`,defaultValue:`0.875rem`,description:`Font size of tour buttons.`},{token:`--b-tour-btn-border-radius`,defaultValue:`0.375rem`,description:`Corner radius of tour buttons.`},{token:`--b-tour-primary-popup-bg`,defaultValue:`oklch(55% 0.169 237.323)`,description:`Background of the popup in primary type.`},{token:`--b-tour-primary-arrow-bg`,defaultValue:`oklch(55% 0.169 237.323)`,description:`Arrow background in primary type.`},{token:`--b-tour-primary-title-color`,defaultValue:`#fff`,description:`Title color in primary type.`},{token:`--b-tour-primary-description-color`,defaultValue:`rgba(255, 255, 255, 0.85)`,description:`Description color in primary type.`},{token:`--b-tour-primary-close-color`,defaultValue:`rgba(255, 255, 255, 0.75)`,description:`Close icon color in primary type.`},{token:`--b-tour-primary-close-hover-color`,defaultValue:`#fff`,description:`Close icon hover color in primary type.`},{token:`--b-tour-primary-indicator-bg`,defaultValue:`rgba(255, 255, 255, 0.4)`,description:`Indicator dot background in primary type.`},{token:`--b-tour-primary-indicator-active-bg`,defaultValue:`#fff`,description:`Active indicator dot background in primary type.`},{token:`--b-tour-transition-duration`,defaultValue:`250ms`,description:`Open/close transition duration.`}],D={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-tour-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BTour:a},setup:()=>({tokens:E}),template:`
...
<span style="color:#89b4fa;">const</span> <span style="color:#cba6f7;">count</span> <span style="color:#89dceb;">=</span> <span style="color:#89b4fa;">ref</span>(<span style="color:#fab387;">0</span>)</code></pre>
  ...
  play: async ({
    ...
    expect(withinPopup.getByRole('button', {
      name: /close tour/i
    })).toBeTruthy();

    // ── 6. Next button has accessible name ───────────────────────────────
    const nextBtn = withinPopup.getByRole('button', {
      name: /next/i
    });
    ...
    await waitFor(() => expect(document.body.querySelector('[role="dialog"]')).toHaveAttribute('aria-label', 'Role Filter'));
...
">
  ...
  play: async ({
    ...
    await waitFor(() => expect(document.body.querySelector('.b-tour__popup .b-tour__title')?.textContent?.trim()).toBe('Upload File'));

    // 4. No prev on step 0
    expect(document.body.querySelector('.b-tour__popup .b-tour__btn--prev')).toBeNull();

    // 5. Next → step 2
    await user.click(within(document.body.querySelector<HTMLElement>('.b-tour__popup')!).getByRole('button', {
      name: /next/i
    }));
    await waitFor(() => expect(document.body.querySelector('.b-tour__popup .b-tour__title')?.textContent?.trim()).toBe('Save to Local Drive'));
    ...
    await waitFor(() => expect(document.body.querySelector('.b-tour__popup .b-tour__title')?.textContent?.trim()).toBe('Share'));
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-tour-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...D.parameters?.docs?.source}}},O=[`Playground`,`Default`,`Primary`,`WithCover`,`NoMask`,`WithTargets`,`CustomIndicators`,`Accessibility`,`Theming`,`InteractionFlow`,`DesignTokens`]}))();export{C as Accessibility,S as CustomIndicators,g as Default,D as DesignTokens,T as InteractionFlow,b as NoMask,h as Playground,_ as Primary,w as Theming,y as WithCover,x as WithTargets,O as __namedExportsOrder,m as default};