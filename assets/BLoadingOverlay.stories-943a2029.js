import{d as b,e as d,k as i,w as p,x as c,j as L,l as u,n as o,T as x,o as m,g,m as S}from"./vue.esm-bundler-d9761a11.js";import{d as a}from"./Enums-b5cac340.js";import{B as f}from"./BOverlay-b94b8bd2.js";import{_ as h}from"./_plugin-vue_export-helper-c27b6911.js";const B=b({__name:"BLoadingOverlay",props:{loading:{type:Boolean},absolute:{type:Boolean,default:!1},spinnerSize:{default:a.Medium}},setup(s){const n=s,r=d(()=>n.absolute?"ds-absolute ":"ds-fixed "),l=d(()=>{let e="spinner ";switch(n.spinnerSize){case a.Small:e+="ds-w-4 ds-h-4 ";break;case a.Large:e+="ds-w-12 ds-h-12 ";break;case a.Medium:default:e+="ds-w-8 ds-h-8 "}return e});return(e,w)=>n.absolute?p((m(),i(f,{key:1,class:o(r.value)},{default:u(()=>[g("div",{class:o(l.value)},null,2)]),_:1},8,["class"])),[[c,e.loading]]):(m(),i(x,{key:0,to:"body"},[p(L(f,{class:o(r.value)},{default:u(()=>[g("div",{class:o(l.value)},null,2)]),_:1},8,["class"]),[[c,e.loading]])]))}});const O=h(B,[["__scopeId","data-v-c49c635e"]]);B.__docgenInfo={exportName:"default",displayName:"BLoadingOverlay",description:"",tags:{},props:[{name:"loading",required:!0,type:{name:"boolean"}},{name:"absolute",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"spinnerSize",required:!1,type:{name:"TSLiteralType"},defaultValue:{func:!1,value:"BLoadingOverlaySpinnerSize.Medium"}}],sourceFiles:["/home/runner/work/design-system/design-system/src/components/BLoadingOverlay.vue"]};const I={title:"Components/LoadingOverlay",parameters:{docs:{description:{component:"The <code>BLoadingOverlay</code> component is used for displaying a loading overlay."}}},component:O,tags:["autodocs"],argTypes:{spinnerSize:{control:"select",options:Object.values(a)}},args:{absolute:!1,spinnerSize:a.Medium}},t={render:s=>({components:{BLoadingOverlay:O},setup(){return S(()=>s.loading,n=>{n&&setTimeout(()=>{s.loading=!1},2e3)},{immediate:!0}),{args:s}},template:`
