import{_ as e}from"./BButton-5b7f8653.js";import{B as S,a as x}from"./Enums-25996506.js";import"./vue.esm-bundler-4cd6df52.js";const _={title:"Components/Button",component:e,tags:["autodocs"],argTypes:{type:{control:"select",options:Object.values(S)},size:{control:"select",options:Object.values(x)},prependIcon:{control:"text",description:"Prepend icon",defaultValue:""},default:{control:"text",description:"Button's content",defaultValue:""},appendIcon:{control:"text",description:"Append icon",defaultValue:""}},args:{type:"primary"}},t={render:n=>({components:{BButton:e},setup(){return{args:n}},template:`
      <BButton v-bind="args">
