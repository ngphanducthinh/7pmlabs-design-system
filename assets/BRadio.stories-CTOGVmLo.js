import{n as e}from"./chunk-BneVvdWh.js";import{K as t,i as n}from"./iframe-BtDITyas.js";import{i as r,n as i,r as a,t as o}from"./BRadio-BaHWx7Ee.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{o(),n(),{expect:s,userEvent:c,waitFor:l,within:u}=__STORYBOOK_MODULE_TEST__,d={title:`Data Entry/Radio`,component:r,tags:[`autodocs`],argTypes:{modelValue:{control:`boolean`,description:`Whether the radio is checked.`,table:{category:`Two-Way Binding Props`}},disabled:{control:`boolean`,description:`Whether the radio is disabled.`,table:{defaultValue:{summary:`false`}}},value:{control:`text`,description:`Value used when inside a BRadioGroup.`},name:{control:`text`,description:`The name attribute of the input element.`},id:{control:`text`,description:`Custom id attribute for the input.`}},parameters:{docs:{description:{component:`<code>BRadio</code> is used to select a single item from a set of options. Supports controlled/uncontrolled usage via <code>v-model</code>, and group composition with <code>BRadioGroup</code>.<br><br>Supports button style via <code>BRadioButton</code> or <code>optionType="button"</code> on the group.<br><br>Fully accessible with keyboard navigation (Tab + Arrow keys) and ARIA attributes.`}}}},f=[{label:`Apple`,value:`apple`},{label:`Banana`,value:`banana`},{label:`Cherry`,value:`cherry`},{label:`Dragonfruit`,value:`dragonfruit`}],p=[{label:`Option A`,value:`a`},{label:`Option B (disabled)`,value:`b`,disabled:!0},{label:`Option C`,value:`c`}],m={args:{modelValue:!1,disabled:!1},render:e=>({components:{BRadio:r},setup:()=>({args:e,checked:t(e.modelValue)}),template:`
