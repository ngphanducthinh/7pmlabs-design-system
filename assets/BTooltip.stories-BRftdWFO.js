...
<!-- … 12 placements total -->
        `}}},render:()=>({components:{BButton:l,BTooltip:c},template:`
    ...
    `})},v={name:`Trigger Variants`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:l,BTooltip:c},template:`
    ...
    `})},y={name:`Custom Colors`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:l,BTooltip:c},template:`
      <div style="padding: 4rem; display: flex; gap: 2rem; justify-content: center;">
    ...
    `})},b={name:`No Arrow`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:l,BTooltip:c},template:`
      <div style="padding: 4rem; display: flex; gap: 2rem; justify-content: center;">
    ...
    `})},x={name:`Title Slot (Rich Content)`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:l,BTooltip:c},template:`
      <div style="padding: 4rem; display: flex; justify-content: center;">
...
.my-custom-tooltip {
  ...
  --b-tooltip-arrow-color: #1a1a2e;
    ...
    `})},D={name:`Snapshot – minimal`,parameters:{controls:{disable:!0},a11y:{test:`error`,context:{include:[`.b-tooltip__toggle`,`.b-tooltip__content`]}}},render:()=>({components:{BButton:l,BTooltip:c},template:`
      <div style="padding: 4rem; display: flex; justify-content: center;">
    ...
    `}),play:async({canvasElement:e})=>{let t=m(e);await f.click(t.getByTestId(`open-snap-no-arrow`)),await p(()=>{let e=document.querySelector(`.b-tooltip__content`);d(e).toBeTruthy(),d(e.querySelector(`.b-tooltip__arrow`)).toBeNull(),d(e.classList.contains(`b-tooltip__content--no-arrow`)).toBe(!0)})}},k={name:`Edge case – controlled v-model`,parameters:{controls:{disable:!0},a11y:{test:`off`},docs:{description:{story:`Tooltip visibility is controlled externally via v-model.`}}},render:()=>({components:{BButton:l,BTooltip:c},setup(){return{open:n(!1)}},template:`
    ...
    `}),play:async({canvasElement:e})=>{let t=m(e),n=e.querySelector(`.b-tooltip__toggle`),r=t.getByTestId(`external-toggle`);await f.click(r),await p(()=>{d(n.getAttribute(`aria-describedby`)).toBeTruthy()}),await f.click(r),await p(()=>{d(n.getAttribute(`aria-describedby`)).toBeNull()})}},A={name:`Edge case – long content`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:l,BTooltip:c},template:`
      <div style="padding: 4rem; display: flex; justify-content: center;">
        <BTooltip
...
}`,...A.parameters?.docs?.source}}},j=[`Playground`,`AllPlacements`,`TriggerVariants`,`CustomColors`,`NoArrow`,`TitleSlot`,`Accessibility`,`InteractionClickOpenClose`,`InteractionKeyboardEscape`,`InteractionFocusTrigger`,`Theming`,`SnapshotMinimal`,`SnapshotNoArrow`,`EdgeCaseControlled`,`EdgeCaseLongContent`]}))();export{S as Accessibility,_ as AllPlacements,y as CustomColors,k as EdgeCaseControlled,A as EdgeCaseLongContent,C as InteractionClickOpenClose,T as InteractionFocusTrigger,w as InteractionKeyboardEscape,b as NoArrow,g as Playground,D as SnapshotMinimal,O as SnapshotNoArrow,E as Theming,x as TitleSlot,v as TriggerVariants,j as __namedExportsOrder,h as default};