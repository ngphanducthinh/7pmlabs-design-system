import{n as e}from"./chunk-BneVvdWh.js";import{D as t,O as n,t as r}from"./components-De-VN3a5.js";var i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{r(),{expect:i,fn:a,userEvent:o,within:s}=__STORYBOOK_MODULE_TEST__,c={title:`Layout/Splitter`,component:t,subcomponents:{BSplitterPanel:n},tags:[`autodocs`],argTypes:{orientation:{control:`select`,options:[`horizontal`,`vertical`],description:"Layout orientation. Takes precedence over `vertical` when set.",table:{defaultValue:{summary:`horizontal`},category:`Props`}},vertical:{control:`boolean`,description:`Convenience boolean for vertical orientation.`,table:{defaultValue:{summary:`false`},category:`Props`}},lazy:{control:`boolean`,description:`Whether the resize is committed only on release (a preview line shows during the drag).`,table:{defaultValue:{summary:`false`},category:`Props`}},collapsible:{control:`object`,description:"Splitter-level collapsible config: `{ motion?: boolean; icon?: { start?, end? } }`.",table:{category:`Props`}},onResize:{table:{category:`Events`}},onResizeStart:{table:{category:`Events`}},onResizeEnd:{table:{category:`Events`}},onCollapse:{table:{category:`Events`}},onDraggerDoubleClick:{table:{category:`Events`}}},parameters:{docs:{description:{component:`The <code>BSplitter</code> component arranges resizable panels. Drag the bar between panels to resize, double-click to fire <code>onDraggerDoubleClick</code>, or use the keyboard (Tab to focus, Arrow keys to move, Enter/Space to toggle collapse).<br><br>Children must be <code>&lt;BSplitterPanel&gt;</code>. Each panel supports <code>size</code> (controlled), <code>defaultSize</code>, <code>min</code>, <code>max</code>, <code>resizable</code>, <code>collapsible</code>, and <code>destroyOnHidden</code>.`}}}},l=`height:100%;display:flex;align-items:center;justify-content:center;background:oklch(96% 0.01 264);font-family:sans-serif;color:#333;border-radius:4px;`,u={args:{orientation:`horizontal`,vertical:!1,lazy:!1},render:e=>({components:{BSplitter:t,BSplitterPanel:n},setup:()=>({args:e}),template:`
    ...
    `})},d={name:`Vertical orientation`,parameters:{controls:{disable:!0}},render:()=>({components:{BSplitter:t,BSplitterPanel:n},template:`
    ...
    `})},f={name:`Min / max constraints`,parameters:{controls:{disable:!0}},render:()=>({components:{BSplitter:t,BSplitterPanel:n},template:`
    ...
    `})},p={name:`Lazy mode (preview during drag)`,parameters:{controls:{disable:!0}},render:()=>({components:{BSplitter:t,BSplitterPanel:n},template:`
      <div style="height:240px;width:100%;border:1px solid #d9d9d9;border-radius:4px;">
        <BSplitter lazy>
    ...
    `})},m={name:`Collapsible panels`,parameters:{controls:{disable:!0}},render:()=>({components:{BSplitter:t,BSplitterPanel:n},template:`
      <div style="height:240px;width:100%;border:1px solid #d9d9d9;border-radius:4px;">
        <BSplitter>
    ...
    `})},h={name:`Non-resizable panel`,parameters:{controls:{disable:!0}},render:()=>({components:{BSplitter:t,BSplitterPanel:n},template:`
...
">
  ...
  <BSplitterPanel>...</BSplitterPanel>
        ...
        `}}},render:()=>({components:{BSplitter:t,BSplitterPanel:n},template:`
