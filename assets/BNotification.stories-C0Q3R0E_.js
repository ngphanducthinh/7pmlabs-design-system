...
/>
    ...
    `}),play:async({canvasElement:e})=>{let t=d(e);c(document.querySelector(`.b-notification`)).toBeNull();let n=t.getByTestId(`show-btn`);await l.click(n),await u(()=>{c(document.querySelector(`.b-notification`)).toBeTruthy()});let r=document.querySelector(`.b-notification`);c(r.classList.contains(`b-notification--info`)).toBe(!0),c(r.getAttribute(`role`)).toBe(`status`),await l.hover(r),c(document.querySelector(`.b-notification`)).toBeTruthy(),await l.unhover(r),c(document.querySelector(`.b-notification`)).toBeTruthy()}},E=[{token:`--b-notification-width`,defaultValue:`24rem`,description:`Width of a single notification (AntD: width).`},{token:`--b-notification-z-index`,defaultValue:`2050`,description:`z-index of the notification stack (AntD: zIndexPopup).`},{token:`--b-notification-bg`,defaultValue:`oklch(100% 0 0)`,description:`Background color of the notification container.`},{token:`--b-notification-border-color`,defaultValue:`oklch(92% 0.005 260)`,description:`Border color of the notification container.`},{token:`--b-notification-border-radius`,defaultValue:`0.5rem`,description:`Corner radius of the notification.`},{token:`--b-notification-shadow`,defaultValue:`0 6px 16px 0 oklch(0% 0 0 / 8%)`,description:`Box shadow under the notification.`},{token:`--b-notification-padding-h`,defaultValue:`1.5rem`,description:`Horizontal padding of the notification.`},{token:`--b-notification-padding-v`,defaultValue:`1rem`,description:`Vertical padding of the notification.`},{token:`--b-notification-gap`,defaultValue:`0.75rem`,description:`Gap between icon, content, and close button.`},{token:`--b-notification-title-color`,defaultValue:`oklch(20% 0.005 260 / 88%)`,description:`Color of the notification title text.`},{token:`--b-notification-desc-color`,defaultValue:`oklch(20% 0.005 260 / 65%)`,description:`Color of the notification description text.`},{token:`--b-notification-font-size-title`,defaultValue:`1rem`,description:`Font size of the title.`},{token:`--b-notification-font-size-desc`,defaultValue:`0.875rem`,description:`Font size of the description.`},{token:`--b-notification-line-height`,defaultValue:`1.5`,description:`Line height of notification text.`},{token:`--b-notification-icon-color`,defaultValue:`oklch(62.3% 0.214 259.815)`,description:`Color of the leading status icon (varies per type).`},{token:`--b-notification-icon-size`,defaultValue:`1.5rem`,description:`Size of the leading status icon.`},{token:`--b-notification-close-color`,defaultValue:`oklch(50% 0.005 260)`,description:`Color of the close button icon.`},{token:`--b-notification-close-hover-color`,defaultValue:`oklch(20% 0.005 260 / 88%)`,description:`Hover color of the close button icon.`},{token:`--b-notification-close-size`,defaultValue:`1rem`,description:`Size of the close button icon.`},{token:`--b-notification-offset`,defaultValue:`1.5rem`,description:`Distance from the viewport edge.`},{token:`--b-notification-transition-duration`,defaultValue:`300ms`,description:`Enter/leave animation duration.`}],D={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-notification-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BNotification:o},setup:()=>({tokens:E}),template:`
...
(Timer pause is verified in unit tests with fake timers.)`,...T.parameters?.docs?.description}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  name: 'Design Tokens',
  parameters: {
    controls: {
      disable: true
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-notification-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...D.parameters?.docs?.source}}},O=[`Playground`,`AllTypes`,`AllPlacements`,`Controlled`,`WithAction`,`CustomIcon`,`WithoutIcon`,`Accessibility`,`Theming`,`InteractionToggle`,`InteractionClose`,`InteractionHoverPause`,`DesignTokens`]}))();export{x as Accessibility,g as AllPlacements,h as AllTypes,_ as Controlled,y as CustomIcon,D as DesignTokens,w as InteractionClose,T as InteractionHoverPause,C as InteractionToggle,m as Playground,S as Theming,v as WithAction,b as WithoutIcon,O as __namedExportsOrder,f as default};