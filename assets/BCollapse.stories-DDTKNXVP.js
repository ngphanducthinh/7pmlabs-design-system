...
<BCollapse accordion :default-active-key="['1']">
  ...
  <BCollapsePanel panel-key="3" header="Panel 3">Content 3</BCollapsePanel>
        ...
        `}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
      <BCollapse accordion :default-active-key="['1']">
        <BCollapsePanel panel-key="1" header="This is panel header 1">
          <p>{{ loremShort }}</p>
        </BCollapsePanel>
    ...
    `})},p={name:`Bordered / Borderless / Ghost`,parameters:{controls:{disable:!0},docs:{description:{story:`Three visual variants: bordered (default), borderless, and ghost.`}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
    ...
    `})},m={parameters:{controls:{disable:!0},docs:{description:{story:`Default and small size variants.`}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
    ...
    `})},h={name:`Expand Icon Position & Collapsible Trigger`,parameters:{controls:{disable:!0},docs:{description:{story:`Expand icon at start/end and collapsible trigger area: header (default), icon only.`}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
      <div style="display: flex; flex-direction: column; gap: 2rem;">
        <div>
    ...
    `})},g={name:`Disabled Panels & Extra Content`,parameters:{controls:{disable:!0},docs:{description:{story:`Panels can be individually disabled. Extra content appears at the end of the header.`}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
      <BCollapse :default-active-key="['1']" >
    ...
    `})},_={name:`Controlled (v-model)`,parameters:{controls:{disable:!0},docs:{description:{story:"Use `v-model` for fully controlled active key state. The badge shows which panels are active."}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{activeKeys:t([`1`]),loremShort:u}},template:`
      <div>
    ...
    `})},v={name:`Accessibility (roles & keyboard)`,parameters:{controls:{disable:!0},docs:{description:{story:'Headers use `role="button"` with `aria-expanded`, `aria-controls`, and `tabindex`. Content regions use `role="region"` with `aria-labelledby` and `aria-hidden`. Keyboard: Tab to focus, Enter/Space to toggle. Arrow icons are `aria-hidden`.'}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
...
<BCollapse class="custom-collapse">
  <BCollapsePanel panel-key="1" header="Custom themed">Content</BCollapsePanel>
    ...
    `})},b={name:`Interaction – toggle, accordion, keyboard`,parameters:{controls:{disable:!0},docs:{description:{story:`Automated play function: verifies click toggling, accordion behavior, keyboard navigation, and disabled state.`}}},render:()=>({components:{BCollapse:r,BCollapsePanel:i},setup(){return{loremShort:u}},template:`
      <div style="display: flex; flex-direction: column; gap: 2rem;">
