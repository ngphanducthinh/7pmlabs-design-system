import{n as e}from"./chunk-BneVvdWh.js";import{A as t,l as n,o as r,u as i}from"./types-CV_3xB-y.js";import{Ct as a,t as o}from"./components-Da5-2MKL.js";var s,c,l,u,d,f,p,m;e((()=>{o(),t(),s={title:`General/Button`,component:a,tags:[`autodocs`],argTypes:{color:{control:`select`,options:Object.values(n)},size:{control:`select`,options:Object.values(i)},variant:{control:`select`,options:Object.values(r)}},parameters:{docs:{description:{component:`The <code>BButton</code> component is a versatile button component that supports various colors, sizes, and variants.<br><br>🔵 Primary button: used for the main action, there can be at most one primary button in a section.<br>⚪️ Secondary button: used for a series of actions without priority.<br>😶 Dashed button: commonly used for adding more actions.<br>🔤 Text button: used for the most secondary action.<br>🔗 Link button: used for external links.`}}}},c={args:{color:n.Primary,size:i.Medium,disabled:!1,variant:r.Solid},render:e=>({components:{BButton:a},setup(){return{args:e}},template:`
    ...
    `})},f=[{token:`--color-primary`,defaultValue:`oklch(55% 0.169 237.323)`,description:`Solid bg / text / outline color for the primary button.`},{token:`--color-primary-hover`,defaultValue:`oklch(48% 0.158 241.966)`,description:`Hover bg / text / outline color for the primary button.`},{token:`--color-primary-hover-light`,defaultValue:`oklch(80% 0.058 230.902)`,description:`Hover background tint used by the text variant of the primary button.`},{token:`--color-secondary`,defaultValue:`oklch(92% 0.004 286.32)`,description:`Solid bg / outline color for the secondary button.`},{token:`--color-secondary-hover`,defaultValue:`oklch(87.1% 0.006 286.286)`,description:`Hover color for the secondary button.`},{token:`--color-secondary-hover-light`,defaultValue:`oklch(96.7% 0.001 286.375)`,description:`Hover background tint for the secondary text variant.`},{token:`--color-success`,defaultValue:`oklch(50% 0.17 149.579)`,description:`Solid bg / text / outline color for the success button.`},{token:`--color-success-hover`,defaultValue:`oklch(43% 0.15 149.214)`,description:`Hover color for the success button.`},{token:`--color-success-hover-light`,defaultValue:`oklch(87.1% 0.15 154.449)`,description:`Hover background tint for the success text variant.`},{token:`--color-failure`,defaultValue:`oklch(55% 0.22 25.331)`,description:`Solid bg / text / outline color for the failure (danger) button.`},{token:`--color-failure-hover`,defaultValue:`oklch(49% 0.21 27.325)`,description:`Hover color for the failure button.`},{token:`--color-failure-hover-light`,defaultValue:`oklch(80.8% 0.114 19.571)`,description:`Hover background tint for the failure text variant.`},{token:`--color-warning`,defaultValue:`oklch(55% 0.16 55.934)`,description:`Solid bg / text / outline color for the warning button.`},{token:`--color-warning-hover`,defaultValue:`oklch(48% 0.15 47.604)`,description:`Hover color for the warning button.`},{token:`--color-warning-hover-light`,defaultValue:`oklch(90.1% 0.076 70.697)`,description:`Hover background tint for the warning text variant.`},{token:`--color-info`,defaultValue:`oklch(55% 0.2 259.815)`,description:`Solid bg / text / outline color for the info button.`},{token:`--color-info-hover`,defaultValue:`oklch(48% 0.2 262.881)`,description:`Hover color for the info button.`},{token:`--color-info-hover-light`,defaultValue:`oklch(80.9% 0.105 251.813)`,description:`Hover background tint for the info text variant.`},{token:`--color-black-base`,defaultValue:`oklch(0 0 0 / 0.8)`,description:`Text color used by the secondary outlined / text / link variants.`}],p={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`BButton has <strong>no component-scoped <code>--b-button-*</code> CSS variables</strong>. It is styled with Tailwind utility classes that resolve against the global theme tokens defined in <code>src/assets/tailwind.css</code>. To retheme buttons, override the <code>--color-*</code> tokens listed below at <code>:root</code> or any ancestor element. AntD button tokens (e.g. <code>defaultBg</code>, <code>primaryShadow</code>, <code>paddingInline</code>) are not yet implemented as dedicated vars.`}}},render:()=>({components:{BButton:a},setup:()=>({tokens:f}),template:`
...
}`,...d.parameters?.docs?.source},description:{story:`This story demonstrates the different button variants available in the BButton component.`,...d.parameters?.docs?.description}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'Design Tokens',
  parameters: {
    controls: {
      disable: true
    ...
    docs: {
      description: {
        story: 'BButton has <strong>no component-scoped <code>--b-button-*</code> CSS variables</strong>. ' + 'It is styled with Tailwind utility classes that resolve against the global theme tokens ' + 'defined in <code>src/assets/tailwind.css</code>. To retheme buttons, override the ' + '<code>--color-*</code> tokens listed below at <code>:root</code> or any ancestor element. ' + 'AntD button tokens (e.g. <code>defaultBg</code>, <code>primaryShadow</code>, ' + '<code>paddingInline</code>) are not yet implemented as dedicated vars.'
      }
    }
  },
  render: () => ({
...
}`,...p.parameters?.docs?.source}}},m=[`Default`,`Color`,`Size`,`Variant`,`DesignTokens`]}))();export{l as Color,c as Default,p as DesignTokens,u as Size,d as Variant,m as __namedExportsOrder,s as default};