import{n as e}from"./chunk-BneVvdWh.js";import{X as t,i as n}from"./iframe-CUduMsgl.js";import{c as r,l as i,s as a,t as o,u as s}from"./components-BVFKI9Ow.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E;e((()=>{o(),s(),n(),{expect:c,fireEvent:l,userEvent:u,waitFor:d,within:f}=__STORYBOOK_MODULE_TEST__,p={page:`
    display: flex;
...
">
  <BTour :steps="steps" v-model:open="open" v-model:current="current" />
    ...
    `,data(){return{UI:p}}}),play:async({canvasElement:e})=>{let t=f(e),n=u.setup();c(document.body.querySelector(`.b-tour__popup`)).toBeNull(),await n.click(t.getByRole(`button`,{name:/start tour/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup`)).not.toBeNull()),await d(()=>c(document.body.querySelector(`.b-tour__popup .b-tour__title`)?.textContent?.trim()).toBe(`Upload File`)),c(document.body.querySelector(`.b-tour__popup .b-tour__btn--prev`)).toBeNull(),await n.click(f(document.body.querySelector(`.b-tour__popup`)).getByRole(`button`,{name:/next/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup .b-tour__title`)?.textContent?.trim()).toBe(`Save to Local Drive`)),c(document.body.querySelector(`.b-tour__popup .b-tour__btn--prev`)).toBeTruthy(),await n.click(f(document.body.querySelector(`.b-tour__popup`)).getByRole(`button`,{name:/next/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup .b-tour__title`)?.textContent?.trim()).toBe(`Share`)),c(document.body.querySelector(`.b-tour__popup .b-tour__btn--next`)?.textContent?.trim()).toBe(`Finish`),await n.click(f(document.body.querySelector(`.b-tour__popup`)).getByRole(`button`,{name:/finish/i})),await d(()=>c(document.body.querySelector(`.b-tour__popup`)).toBeNull())},parameters:{docs:{description:{story:`Automated interaction test: open → step through Upload / Save / Share → Finish → verify closed.`}}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    open: false,
...
}`,...T.parameters?.docs?.source}}},E=[`Playground`,`Default`,`Primary`,`WithCover`,`NoMask`,`WithTargets`,`CustomIndicators`,`Accessibility`,`Theming`,`InteractionFlow`]}))();export{C as Accessibility,S as CustomIndicators,g as Default,T as InteractionFlow,b as NoMask,h as Playground,_ as Primary,w as Theming,y as WithCover,x as WithTargets,E as __namedExportsOrder,m as default};