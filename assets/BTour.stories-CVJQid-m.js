import{n as e}from"./chunk-BneVvdWh.js";import{K as t,i as n}from"./iframe-BMgVmRCG.js";import{a as r,i,n as a,r as o,t as s}from"./components-DBCIcu8v.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E;e((()=>{s(),r(),n(),{expect:c,fireEvent:l,userEvent:u,waitFor:d,within:f}=__STORYBOOK_MODULE_TEST__,p={page:`
    display: flex;
  ...
  `,divider:`height: 1px; background: #e5e7eb; margin: 0.25rem 0;`},m={title:`Data Display/Tour`,component:a,tags:[`autodocs`],argTypes:{open:{control:`boolean`,description:`Controlled open state.`,table:{category:`Two-Way Binding Props`}},current:{control:`number`,description:`Controlled current step index.`,table:{category:`Two-Way Binding Props`}},type:{control:`select`,options:Object.values(i),description:`Visual variant.`},placement:{control:`select`,options:Object.values(o),description:`Default popup placement (step-level overrides).`},mask:{control:`boolean`,description:`Show a mask overlay with spotlight cutout.`},arrow:{control:`boolean`,description:`Show the directional arrow.`},keyboard:{control:`boolean`,description:`Enable keyboard navigation.`},zIndex:{control:`number`,description:`z-index of the popup and mask.`},closeIcon:{control:`boolean`,description:`Show the close button.`},disabledInteraction:{control:`boolean`,description:`Disable pointer interaction on highlighted region.`},onChange:{action:`change`},onClose:{action:`close`},onFinish:{action:`finish`}},parameters:{docs:{description:{component:`The <code>BTour</code> component guides users through a product with step-by-step popups. It supports both controlled and uncontrolled modes, keyboard navigation, SVG spotlight masking, and full dark-mode theming.`}}}},h={args:{open:!1,type:i.Default,placement:o.Bottom,mask:!0,arrow:!0,keyboard:!0,zIndex:1070,closeIcon:!0,disabledInteraction:!1},render:e=>({components:{BTour:a},setup(){return{args:e,isOpen:t(!1),currentStep:t(0),steps:[{title:`New Document`,description:`Create a new file or folder to get started.`,target:()=>document.getElementById(`pg-new`),placement:o.Bottom},{title:`Upload Files`,description:`Drag & drop or click to upload files from your device.`,target:()=>document.getElementById(`pg-upload`),placement:o.Bottom},{title:`Search`,description:`Quickly find any file by name, tag, or content.`,target:()=>document.getElementById(`pg-search`),placement:o.Bottom},{title:`Share & Collaborate`,description:`Invite teammates and control their access level.`,target:()=>document.getElementById(`pg-share`),placement:o.Bottom}]}},template:`
    ...
    `,data(){return{UI:p}}})},g={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`New Document`,description:`Create a blank document, spreadsheet, or presentation in one click.`,target:()=>document.getElementById(`def-new`),placement:o.Bottom},{title:`Upload Files`,description:`Drag & drop or browse your device to upload files up to 2 GB.`,target:()=>document.getElementById(`def-upload`),placement:o.Bottom},{title:`Filter & Sort`,description:`Narrow results by type, owner, or date modified.`,target:()=>document.getElementById(`def-filter`),placement:o.BottomLeft},{title:`Share`,description:`Invite teammates with view or edit access.`,target:()=>document.getElementById(`def-share`),placement:o.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page">
        <div :style="UI.toolbar">
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Default type with four toolbar targets - New, Upload, Filter, and Share.`}}}},_={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Overview Panel`,description:`Your key metrics at a glance - visits, conversions, and revenue.`,target:()=>document.getElementById(`pri-overview`),placement:o.Bottom,type:i.Primary},{title:`Activity Feed`,description:`A real-time stream of team actions and system events.`,target:()=>document.getElementById(`pri-activity`),placement:o.Left,type:i.Primary},{title:`Quick Actions`,description:`Run frequent tasks without leaving the dashboard.`,target:()=>document.getElementById(`pri-actions`),placement:o.Top,type:i.Primary},{title:`User Menu`,description:`Access your profile, settings, and sign-out options.`,target:()=>document.getElementById(`pri-user`),placement:o.BottomRight,type:i.Primary}],isOpen:e,step:n}},template:`
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Primary type spotlighting four dashboard regions - overview panel, activity feed, quick actions, and user menu.`},source:{code:`<BTour :steps="steps" type="primary" v-model:open="open" v-model:current="current" />`}}}},v=`https://user-images.githubusercontent.com/5378891/197385811-55df8480-7ff4-44bd-9d43-a7dade598d70.png`,y={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Welcome to CloudDrive`,description:`A quick tour of the features that help you store, share, and collaborate.`,cover:v,target:()=>document.getElementById(`cov-logo`),placement:o.BottomLeft},{title:`Your Storage`,description:`See how much space you have used and upgrade at any time.`,cover:v,target:()=>document.getElementById(`cov-storage`),placement:o.Right},{title:`Recent Files`,description:`Jump back into documents you recently opened or edited.`,cover:v,target:()=>document.getElementById(`cov-recent`),placement:o.Top},{title:`Notifications`,description:`Stay informed about comments, shares, and system alerts.`,cover:v,target:()=>document.getElementById(`cov-bell`),placement:o.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <!-- Header -->
        <div style="display:flex; align-items:center; gap:0.75rem; padding:0.5rem 0.75rem; background:#fff; border:1px solid #e5e7eb; border-radius:0.5rem;">
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Each step includes a cover image above the title. The tour spotlights logo, storage bar, recent files, and notifications.`}}}},b={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Profile`,description:`Update your display name, avatar, and contact details.`,target:()=>document.getElementById(`nm-profile`),placement:o.Right},{title:`Notifications`,description:`Choose which events trigger email or push notifications.`,target:()=>document.getElementById(`nm-notif`),placement:o.Right},{title:`Security`,description:`Enable two-factor authentication and review active sessions.`,target:()=>document.getElementById(`nm-security`),placement:o.Right},{title:`Billing`,description:`Manage your subscription, invoices, and payment methods.`,target:()=>document.getElementById(`nm-billing`),placement:o.Right}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:"`mask=false` - the overlay is removed so users can still interact with the page while the tour runs."}}}},x={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Run Code`,description:`Execute the current file and see output in the panel below.`,target:()=>document.getElementById(`wt-run`),placement:o.Bottom},{title:`Format`,description:`Auto-format your code with Prettier on save or on demand.`,target:()=>document.getElementById(`wt-format`),placement:o.Bottom},{title:`Terminal`,description:`Open an integrated terminal pane at the bottom of the editor.`,target:()=>document.getElementById(`wt-terminal`),placement:o.Bottom},{title:`Extensions`,description:`Browse and install plugins to extend editor functionality.`,target:()=>document.getElementById(`wt-ext`),placement:o.BottomRight},{title:`Settings`,description:`Customise keybindings, themes, and editor preferences.`,target:()=>document.getElementById(`wt-settings`),placement:o.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <!-- Editor chrome -->
...
<span style="color:#89b4fa;">const</span> <span style="color:#cba6f7;">count</span> <span style="color:#89dceb;">=</span> <span style="color:#89b4fa;">ref</span>(<span style="color:#fab387;">0</span>)</code></pre>
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:`Five targeted steps across a code-editor toolbar - Run, Format, Terminal, Extensions, and Settings.`}}}},S={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Cart Summary`,description:`Review your items, quantities, and individual prices here.`,target:()=>document.getElementById(`ci-cart`),placement:o.Left},{title:`Promo Code`,description:`Enter a discount code to reduce your total at checkout.`,target:()=>document.getElementById(`ci-promo`),placement:o.Top},{title:`Shipping Options`,description:`Choose between standard, express, or same-day delivery.`,target:()=>document.getElementById(`ci-shipping`),placement:o.Top},{title:`Place Order`,description:`Confirm your order once you are happy with everything.`,target:()=>document.getElementById(`ci-order`),placement:o.Top}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <div style="display:grid; grid-template-columns:1fr 280px; gap:0.75rem;">
          <!-- Order form -->
    ...
    `,data(){return{UI:p}}}),parameters:{docs:{description:{story:'The `indicatorsRender` slot replaces dots with a "current / total" counter. Tour targets a checkout page.'}}}},C={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Invite Members`,description:`Add new team members by email and assign them a role.`,target:()=>document.getElementById(`a11y-invite`),placement:o.Bottom},{title:`Role Filter`,description:`Filter the list to show only Admins, Editors, or Viewers.`,target:()=>document.getElementById(`a11y-filter`),placement:o.Bottom},{title:`Bulk Actions`,description:`Select multiple rows then apply actions like Remove or Change Role.`,target:()=>document.getElementById(`a11y-bulk`),placement:o.BottomLeft},{title:`Export`,description:`Download the full member list as a CSV file.`,target:()=>document.getElementById(`a11y-export`),placement:o.BottomRight}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
...
</div>`}}}},T={render:()=>({components:{BTour:a},setup(){let e=t(!1),n=t(0);return{steps:[{title:`Upload File`,description:`Put your files here to start the upload process.`,target:()=>document.getElementById(`if-upload`),placement:o.Bottom},{title:`Save to Local Drive`,description:`Save your files to a local drive for backup.`,target:()=>document.getElementById(`if-save`),placement:o.Bottom},{title:`Share`,description:`Share your files with friends and colleagues.`,target:()=>document.getElementById(`if-share`),placement:o.Bottom}],isOpen:e,step:n}},template:`
      <div :style="UI.page" style="gap:0.75rem;">
        <div :style="UI.toolbar">
