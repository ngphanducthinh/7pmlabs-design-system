...
]" />`}}},render:()=>({components:{BTimeline:r},setup(){return{BASIC_ITEMS:l}},template:`
      <div style="padding: 2rem; max-width: 500px;">
...
]" />`}}},render:()=>({components:{BTimeline:r},setup(){return{colorItems:[{content:`Blue (default)`,color:`blue`},{content:`Green - success`,color:`green`},{content:`Red - error`,color:`red`},{content:`Gray - neutral`,color:`gray`},{content:`Custom purple (oklch)`,color:`oklch(60% 0.2 300)`}]}},template:`
      <div style="padding: 2rem; max-width: 500px;">
        <BTimeline data-testid="colors" :items="colorItems" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=s(e).getByTestId(`colors`).querySelectorAll(`.b-timeline-item`);o(t[0].classList.contains(`b-timeline-item--blue`)).toBe(!0),o(t[1].classList.contains(`b-timeline-item--green`)).toBe(!0),o(t[2].classList.contains(`b-timeline-item--red`)).toBe(!0),o(t[3].classList.contains(`b-timeline-item--gray`)).toBe(!0),o(t[4].classList.contains(`b-timeline-item--custom`)).toBe(!0),o(t[4].style.getPropertyValue(`--b-timeline-item-dot-color`)).toBeTruthy()}},p={name:`Mode: Alternate`,parameters:{controls:{disable:!0},docs:{source:{code:`<BTimeline mode="alternate" :items="items" />`}}},render:()=>({components:{BTimeline:r},setup(){return{altItems:[{content:`Create a services site`,title:`2015-09-01`,color:`blue`},{content:`Solve initial network problems`,title:`2015-09-01`,color:`green`},{content:`Technical testing`,title:`2015-09-01`,color:`red`},{content:`Network problems being solved`,title:`2015-09-01`,color:`gray`}]}},template:`
      <div style="padding: 2rem; max-width: 600px;">
        <BTimeline data-testid="alternate" mode="alternate" :items="altItems" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=s(e).getByTestId(`alternate`);o(t.classList.contains(`b-timeline--alternate`)).toBe(!0);let n=t.querySelectorAll(`.b-timeline-item`);o(n[0].classList.contains(`b-timeline-item--left`)).toBe(!0),o(n[1].classList.contains(`b-timeline-item--right`)).toBe(!0),o(n[2].classList.contains(`b-timeline-item--left`)).toBe(!0),o(n[3].classList.contains(`b-timeline-item--right`)).toBe(!0)}},m={name:`Mode: End`,parameters:{controls:{disable:!0},docs:{source:{code:`<BTimeline mode="end" :items="items" />`}}},render:()=>({components:{BTimeline:r},setup(){return{BASIC_ITEMS:l}},template:`
      <div style="padding: 2rem; max-width: 500px;">
        <BTimeline data-testid="right" mode="end" :items="BASIC_ITEMS" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=s(e).getByTestId(`right`);o(t.classList.contains(`b-timeline--end`)).toBe(!0),t.querySelectorAll(`.b-timeline-item`).forEach(e=>{o(e.classList.contains(`b-timeline-item--right`)).toBe(!0)})}},h={parameters:{controls:{disable:!0},docs:{source:{code:`<BTimeline :items="items" pending="Ongoing task..." />`}}},render:()=>({components:{BTimeline:r},setup(){return{BASIC_ITEMS:l}},template:`
      <div style="padding: 2rem; max-width: 500px;">
...
]" />`}}},render:()=>({components:{BTimeline:r},setup(){return{dotItems:[{content:`Checked in`,icon:`✓`,color:`green`},{content:`Flagged`,icon:`⚑`,color:`red`},{content:`Star event`,icon:`★`,color:`blue`}]}},template:`
      <div style="padding: 2rem; max-width: 500px;">
...
</BTimeline>`}}},render:()=>({components:{BTimeline:r,BTimelineItem:i},template:`
      <div style="padding: 2rem; max-width: 500px;">
...
<!-- Outlined -->
<BTimeline variant="outlined" :items="items" />`}}},render:()=>({components:{BTimeline:r},setup(){return{BASIC_ITEMS:l}},template:`
