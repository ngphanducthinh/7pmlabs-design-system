...
<BCollapse class="custom-collapse">
  <BCollapsePanel panel-key="1" header="Custom themed">Content</BCollapsePanel>
    ...
    `}),play:async({canvasElement:e})=>{let t=c(e),n=t.getByTestId(`basic-panel-1`),r=n.querySelector(`.b-collapse-panel__header`);o(n.classList.contains(`b-collapse-panel--active`)).toBe(!1),await s.click(r),o(n.classList.contains(`b-collapse-panel--active`)).toBe(!0),await s.click(r),o(n.classList.contains(`b-collapse-panel--active`)).toBe(!1);let i=t.getByTestId(`basic-panel-2`),a=i.querySelector(`.b-collapse-panel__header`);await s.click(r),await s.click(a),o(n.classList.contains(`b-collapse-panel--active`)).toBe(!0),o(i.classList.contains(`b-collapse-panel--active`)).toBe(!0);let l=t.getByTestId(`acc-panel-a`),u=t.getByTestId(`acc-panel-b`),d=l.querySelector(`.b-collapse-panel__header`),f=u.querySelector(`.b-collapse-panel__header`);await s.click(d),o(l.classList.contains(`b-collapse-panel--active`)).toBe(!0),o(u.classList.contains(`b-collapse-panel--active`)).toBe(!1),await s.click(f),o(l.classList.contains(`b-collapse-panel--active`)).toBe(!1),o(u.classList.contains(`b-collapse-panel--active`)).toBe(!0),await s.click(d),d.focus(),await s.keyboard(`{Enter}`),o(l.classList.contains(`b-collapse-panel--active`)).toBe(!1)}},x=[{token:`--b-collapse-content-bg`,defaultValue:`oklch(100% 0 0)`,description:`Background of the panel content (AntD: contentBg).`},{token:`--b-collapse-content-padding`,defaultValue:`16px`,description:`Padding inside the panel content (AntD: contentPadding).`},{token:`--b-collapse-header-bg`,defaultValue:`oklch(97% 0 0)`,description:`Background of the panel header (AntD: headerBg).`},{token:`--b-collapse-header-padding`,defaultValue:`12px 16px`,description:`Padding of the panel header (AntD: headerPadding).`},{token:`--b-collapse-border-color`,defaultValue:`oklch(88% 0 0)`,description:`Border color around the collapse and between panels.`},{token:`--b-collapse-border-radius`,defaultValue:`8px`,description:`Outer corner radius.`},{token:`--b-collapse-header-color`,defaultValue:`oklch(15% 0 0)`,description:`Header text color.`},{token:`--b-collapse-header-font-size`,defaultValue:`14px`,description:`Header text font size.`},{token:`--b-collapse-header-font-weight`,defaultValue:`500`,description:`Header text font weight.`},{token:`--b-collapse-header-line-height`,defaultValue:`1.5`,description:`Header text line height.`},{token:`--b-collapse-content-color`,defaultValue:`oklch(27% 0.01 260)`,description:`Content text color.`},{token:`--b-collapse-arrow-color`,defaultValue:`oklch(45% 0 0)`,description:`Color of the chevron arrow.`},{token:`--b-collapse-arrow-size`,defaultValue:`12px`,description:`Size of the chevron arrow.`},{token:`--b-collapse-extra-color`,defaultValue:`oklch(45% 0 0)`,description:`Color of the extra slot.`},{token:`--b-collapse-disabled-bg`,defaultValue:`oklch(96% 0 0)`,description:`Background of disabled panel headers.`},{token:`--b-collapse-disabled-color`,defaultValue:`oklch(63% 0 0)`,description:`Text color of disabled panel headers.`},{token:`--b-collapse-transition-duration`,defaultValue:`300ms`,description:`Duration of the expand/collapse transition.`}],S={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-collapse-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BCollapse:a,BCollapsePanel:r},setup:()=>({tokens:x}),template:`
...
<BCollapse class="custom-collapse">
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-collapse-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...S.parameters?.docs?.source}}},C=[`Playground`,`Accordion`,`Variants`,`Sizes`,`ExpandIconAndTrigger`,`DisabledAndExtra`,`Controlled`,`Accessibility`,`Theming`,`InteractionTests`,`DesignTokens`]}))();export{v as Accessibility,f as Accordion,_ as Controlled,S as DesignTokens,g as DisabledAndExtra,h as ExpandIconAndTrigger,b as InteractionTests,d as Playground,m as Sizes,y as Theming,p as Variants,C as __namedExportsOrder,l as default};