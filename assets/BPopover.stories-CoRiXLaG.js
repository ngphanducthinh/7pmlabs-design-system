import{n as e}from"./chunk-BneVvdWh.js";import{K as t,X as n,Z as r,i}from"./iframe-CT7ZgrLF.js";import{A as a,S as o,x as s}from"./types-CV_3xB-y.js";import{Ct as c,L as l,t as u}from"./components-BHsxChsf.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;e((()=>{u(),a(),i(),{expect:d,userEvent:f,waitFor:p,within:m}=__STORYBOOK_MODULE_TEST__,h={title:`Data Display/Popover`,component:l,tags:[`autodocs`],argTypes:{title:{control:`text`,description:`The title shown at the top of the popover.`},content:{control:`text`,description:`The main content of the popover.`},trigger:{control:`select`,options:Object.values(o),description:`The event that triggers the popover.`,table:{defaultValue:{summary:o.Hover}}},placement:{control:`select`,options:Object.values(s),description:`Placement of the popover relative to the target.`,table:{defaultValue:{summary:s.TopCenter}}},arrow:{control:`boolean`,description:`Whether the popover has an arrow.`,table:{defaultValue:{summary:`true`}}},mouseEnterDelay:{control:`number`,description:`Delay in ms before showing on mouseenter.`,table:{defaultValue:{summary:`100`}}},mouseLeaveDelay:{control:`number`,description:`Delay in ms before hiding on mouseleave.`,table:{defaultValue:{summary:`100`}}},destroyTooltipOnHide:{control:`boolean`,description:`Destroy popover DOM when hidden.`,table:{defaultValue:{summary:`false`}}},fresh:{control:`boolean`,description:`Force re-render when popover is shown.`,table:{defaultValue:{summary:`false`}}},zIndex:{control:`number`,description:`z-index of the popover.`,table:{defaultValue:{summary:`1030`}}},modelValue:{control:`boolean`,description:`Controlled visibility (bind with v-model).`,table:{category:`Two-Way Binding Props`}}},parameters:{docs:{description:{component:`The <code>BPopover</code> component displays rich content in a floating card triggered by user interaction.<br><br>It uses the native HTML <code>popover</code> attribute and CSS Anchor Positioning for overlay management.<br>Supports 12 placements, three trigger modes (hover, click, focus), optional title, and full accessibility.`}}}},g={args:{title:`Popover Title`,content:`This is the popover content area. You can place any information here.`,trigger:`hover`,placement:`top-center`,arrow:!0,destroyTooltipOnHide:!1,fresh:!1,zIndex:1030},render:e=>({components:{BButton:c,BPopover:l},setup(){let i=n(e.modelValue??void 0);return t(r(()=>e.modelValue),e=>{i.value=e}),{args:e,open:i}},template:`
    ...
    `}),play:async({canvasElement:e})=>{let t=m(e).getAllByRole(`button`);await f.hover(t[0]),await p(()=>{d(document.querySelector(`.b-popover__content`)).toBeTruthy(),d(document.querySelector(`.b-popover__title`)?.textContent).toBe(`Title`),d(document.querySelector(`.b-popover__body`)?.textContent).toBe(`Content of the popover.`)}),await f.unhover(t[0])}},v={name:`Trigger Modes`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:c,BPopover:l},template:`
      <div style="padding: 6rem; display: flex; gap: 2rem; justify-content: center;">
...
<!-- … 12 placements total -->
        `}}},render:()=>({components:{BButton:c,BPopover:l},template:`
    ...
    `})},b={name:`Rich Content (slots)`,parameters:{controls:{disable:!0},a11y:{test:`off`}},render:()=>({components:{BButton:c,BPopover:l},template:`
      <div style="padding: 6rem; display: flex; gap: 2rem; justify-content: center;">
...
.my-custom-popover {
  ...
  --b-popover-title-color: #faad14;
    ...
    `})},T={name:`Edge case – controlled v-model`,parameters:{controls:{disable:!0},a11y:{test:`off`},docs:{description:{story:`Popover visibility is controlled externally via v-model.`}}},render:()=>({components:{BButton:c,BPopover:l},setup(){return{open:n(!1)}},template:`
    ...
    `})},D={name:`Snapshot – minimal`,parameters:{controls:{disable:!0},a11y:{test:`error`,context:{include:[`.b-popover__toggle`,`.b-popover__content`]}}},render:()=>({components:{BButton:c,BPopover:l},template:`
      <div style="padding: 6rem; display: flex; justify-content: center;">
        <BPopover title="Snapshot" content="Minimal snapshot popover." trigger="click">
          <BButton data-testid="open-snap">Open</BButton>
        </BPopover>
      </div>
    `}),play:async({canvasElement:e})=>{let t=m(e);await f.click(t.getByTestId(`open-snap`)),await p(()=>{let e=document.querySelector(`.b-popover__content`);d(e).toBeTruthy(),d(e.querySelector(`.b-popover__inner`)).toBeTruthy(),d(e.querySelector(`.b-popover__arrow`)).toBeTruthy(),d(e.querySelector(`.b-popover__title`)).toBeTruthy(),d(e.querySelector(`.b-popover__body`)).toBeTruthy(),d(e.getAttribute(`role`)).toBe(`tooltip`)})}},O=[{token:`--b-popover-min-width`,defaultValue:`177px`,description:`Minimum width of the popover (AntD: titleMinWidth).`},{token:`--b-popover-bg`,defaultValue:`#fff`,description:`Background of the popover panel.`},{token:`--b-popover-color`,defaultValue:`oklch(25% 0 0)`,description:`Default text color in the popover.`},{token:`--b-popover-arrow-color`,defaultValue:`#fff`,description:`Background color of the arrow (matches the panel).`},{token:`--b-popover-arrow-size`,defaultValue:`8px`,description:`Size (half-width) of the arrow.`},{token:`--b-popover-border-radius`,defaultValue:`0.5rem`,description:`Corner radius of the popover.`},{token:`--b-popover-shadow`,defaultValue:`0 6px 16px 0 oklch(0% 0 0 / 8%), 0 3px 6px -4px oklch(0% 0 0 / 12%)`,description:`Box shadow of the popover.`},{token:`--b-popover-padding-x`,defaultValue:`0.75rem`,description:`Horizontal padding inside the popover.`},{token:`--b-popover-padding-y`,defaultValue:`0.75rem`,description:`Vertical padding inside the popover.`},{token:`--b-popover-gap`,defaultValue:`8px`,description:`Distance between the popover and its trigger.`},{token:`--b-popover-max-width`,defaultValue:`320px`,description:`Maximum width of the popover.`},{token:`--b-popover-font-size`,defaultValue:`0.875rem`,description:`Font size of the popover body.`},{token:`--b-popover-line-height`,defaultValue:`1.5`,description:`Line height of the popover body.`},{token:`--b-popover-body-color`,defaultValue:`oklch(35% 0 0)`,description:`Body text color.`},{token:`--b-popover-title-color`,defaultValue:`oklch(15% 0 0)`,description:`Title text color.`},{token:`--b-popover-title-font-size`,defaultValue:`0.875rem`,description:`Title font size.`},{token:`--b-popover-title-font-weight`,defaultValue:`600`,description:`Title font weight.`},{token:`--b-popover-title-margin-bottom`,defaultValue:`0.5rem`,description:`Margin below the title.`},{token:`--b-popover-title-padding-bottom`,defaultValue:`0.5rem`,description:`Padding below the title (above the divider).`},{token:`--b-popover-title-border-bottom`,defaultValue:`1px solid oklch(90% 0 0)`,description:`Divider between the title and the body.`},{token:`--b-popover-transition-duration`,defaultValue:`200ms`,description:`Open/close animation duration.`}],k={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-popover-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BButton:c,BPopover:l},setup:()=>({tokens:O}),template:`
...
.my-custom-popover {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-popover-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...k.parameters?.docs?.source}}},A=[`Playground`,`BasicPopover`,`TriggerModes`,`AllPlacements`,`RichContent`,`Accessibility`,`InteractionClickFlow`,`InteractionKeyboardEscape`,`Theming`,`EdgeCaseControlled`,`EdgeCaseLongContent`,`SnapshotMinimal`,`DesignTokens`]}))();export{x as Accessibility,y as AllPlacements,_ as BasicPopover,k as DesignTokens,T as EdgeCaseControlled,E as EdgeCaseLongContent,S as InteractionClickFlow,C as InteractionKeyboardEscape,g as Playground,b as RichContent,D as SnapshotMinimal,w as Theming,v as TriggerModes,A as __namedExportsOrder,h as default};