import{n as e}from"./chunk-BneVvdWh.js";import{ht as t,t as n}from"./components-CBHFLACH.js";var r,i,a,o,s,c,l,u,d,f,p,m;e((()=>{n(),{expect:r,within:i}=__STORYBOOK_MODULE_TEST__,a=[{text:`Home`,href:`/`},{text:`Application Center`,href:`/app`},{text:`Application List`,href:`/app/list`},{text:`An Application`}],o={title:`Navigation/Breadcrumb`,component:t,tags:[`autodocs`],argTypes:{separator:{control:`text`,description:`Custom separator string`},items:{control:`object`,description:`Array of breadcrumb items`}},parameters:{docs:{description:{component:`The <code>BBreadcrumb</code> component shows the current page location within a navigational hierarchy. Supports responsive collapsing, custom separators, icons, and custom item/separator slots.`}}}},s={args:{items:a,separator:`/`},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`<BBreadcrumb v-bind="args" />`})},c={args:{items:a,separator:`>`},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`<BBreadcrumb v-bind="args" />`})},l={args:{items:[{text:`Home`,href:`/`,icon:`house`},{text:`Products`,href:`/products`,icon:`box`},{text:`Detail`}],separator:`/`},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`<BBreadcrumb v-bind="args" />`})},u={args:{items:a,separator:`/`},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`
      <div style="width: 240px; border: 1px dashed #ccc; padding: 8px;">
        <BBreadcrumb v-bind="args" />
      </div>
    `}),parameters:{docs:{description:{story:`In a narrow container, middle items collapse into a "•••" menu. Click to reveal them.`}}}},d={args:{items:a},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`
      <BBreadcrumb v-bind="args">
        <template #item-0="{ item }">
          <span style="font-weight:700; color: var(--b-breadcrumb-link-hover-color)">🏠 {{ item.text }}</span>
        </template>
      </BBreadcrumb>
    `})},f={args:{items:a,separator:`/`},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`<BBreadcrumb v-bind="args" />`}),parameters:{docs:{description:{story:`Verifies semantic roles, aria attributes, and keyboard navigation. The last item carries <code>aria-current="page"</code>; separators are <code>aria-hidden</code>.`}}},play:async({canvasElement:e})=>{i(e);let t=e.querySelectorAll(`a.b-breadcrumb__link`),n=t[t.length-1];r(n.getAttribute(`aria-current`)).toBe(`page`),r(e.querySelector(`nav.b-breadcrumb`)?.getAttribute(`aria-label`)).toBe(`Breadcrumb`),e.querySelectorAll(`.b-breadcrumb__separator`).forEach(e=>{r(e.closest(`[aria-hidden="true"]`)||e.getAttribute(`aria-hidden`)).toBeTruthy()}),t[0].focus(),r(document.activeElement).toBe(t[0])}},p={args:{items:a,separator:`/`},render:e=>({components:{BBreadcrumb:t},setup(){return{args:e}},template:`
