...
<BEmpty class="custom-empty" description="Styled empty" />
    ...
    `}),play:async({canvasElement:e})=>{let t=o(e),n=t.getByTestId(`int-default`);a(n.querySelector(`.b-empty__svg--default`)).toBeTruthy(),a(n.querySelector(`.b-empty__description`)?.textContent?.trim()).toBe(`No data`),a(n.querySelector(`.b-empty__footer`)).toBeNull();let r=t.getByTestId(`int-simple`);a(r.classList.contains(`b-empty--simple`)).toBe(!0),a(r.querySelector(`.b-empty__svg--simple`)).toBeTruthy(),a(r.querySelector(`.b-empty__description`)?.textContent?.trim()).toBe(`Simple variant`);let i=t.getByTestId(`int-action`);a(i.querySelector(`.b-empty__footer`)).toBeTruthy(),a(i.querySelector(`[data-testid="int-action-btn"]`)).toBeTruthy(),a(t.getByTestId(`int-no-desc`).querySelector(`.b-empty__description`)).toBeNull()}},g=[{token:`--b-empty-description-color`,defaultValue:`oklch(55% 0.01 260)`,description:`Color of the description text (AntD: colorTextDescription).`},{token:`--b-empty-image-opacity`,defaultValue:`1`,description:`Opacity of the empty image (AntD: opacityImage).`},{token:`--b-empty-padding`,defaultValue:`32px 0`,description:`Padding around the empty container.`},{token:`--b-empty-text-align`,defaultValue:`center`,description:`Text alignment of the empty content.`},{token:`--b-empty-image-height`,defaultValue:`152px`,description:`Height of the default empty illustration.`},{token:`--b-empty-image-height-simple`,defaultValue:`35px`,description:`Height of the simple empty illustration.`},{token:`--b-empty-image-margin-bottom`,defaultValue:`8px`,description:`Margin below the image.`},{token:`--b-empty-description-font-size`,defaultValue:`14px`,description:`Font size of the description.`},{token:`--b-empty-description-line-height`,defaultValue:`1.572`,description:`Line height of the description.`},{token:`--b-empty-description-margin-top`,defaultValue:`8px`,description:`Margin above the description text.`},{token:`--b-empty-footer-margin-top`,defaultValue:`16px`,description:`Margin above the footer slot (e.g., action buttons).`},{token:`--b-empty-ellipse-fill`,defaultValue:`oklch(93% 0.005 260)`,description:`Fill color of the shadow ellipse in the default image.`},{token:`--b-empty-path-bg-fill`,defaultValue:`oklch(95% 0.003 260)`,description:`Fill color of the background path.`},{token:`--b-empty-path-dot-fill`,defaultValue:`oklch(83% 0.01 260)`,description:`Fill color of decorative dots.`},{token:`--b-empty-path-dots-group-fill`,defaultValue:`oklch(100% 0 0)`,description:`Fill color of the dots group container.`},{token:`--b-empty-path-front-fill`,defaultValue:`oklch(97% 0.002 260)`,description:`Fill color of the front path.`},{token:`--b-empty-path-front-stroke`,defaultValue:`oklch(83% 0.01 260)`,description:`Stroke color of the front path.`},{token:`--b-empty-path-main-fill`,defaultValue:`oklch(97% 0.002 260)`,description:`Fill color of the main path.`},{token:`--b-empty-path-panel-fill`,defaultValue:`oklch(93% 0.005 260)`,description:`Fill color of the panel path.`},{token:`--b-empty-simple-ellipse-fill`,defaultValue:`oklch(93% 0.005 260)`,description:`Fill color of the simple variant ellipse.`},{token:`--b-empty-simple-group-fill`,defaultValue:`oklch(97% 0.002 260)`,description:`Fill color of the simple variant group.`},{token:`--b-empty-simple-group-stroke`,defaultValue:`oklch(83% 0.01 260)`,description:`Stroke color of the simple variant group.`},{token:`--b-empty-simple-inner-fill`,defaultValue:`oklch(93% 0.005 260)`,description:`Fill color of the simple variant inner shape.`},{token:`--b-empty-transition-duration`,defaultValue:`200ms`,description:`Duration of color transitions.`}],_={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-empty-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BEmpty:r},setup:()=>({tokens:g}),template:`
...
}`,...h.parameters?.docs?.source},description:{story:`Automated interaction tests: verify rendering, slots, and DOM structure.`,...h.parameters?.docs?.description}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: 'Design Tokens',
  parameters: {
    controls: {
      disable: true
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-empty-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,..._.parameters?.docs?.source}}},v=[`Playground`,`ImageVariants`,`CustomDescription`,`WithAction`,`CustomImageSlot`,`Accessibility`,`Theming`,`InteractionTests`,`DesignTokens`]}))();export{p as Accessibility,u as CustomDescription,f as CustomImageSlot,_ as DesignTokens,l as ImageVariants,h as InteractionTests,c as Playground,m as Theming,d as WithAction,v as __namedExportsOrder,s as default};