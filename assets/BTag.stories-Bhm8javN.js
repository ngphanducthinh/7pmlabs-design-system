...
<BTag closable>
  ...
  Rounded blue
    ...
    `}),play:async({canvasElement:e})=>{let t=s(e),n=t.getByTestId(`int-uncontrolled`).querySelector(`.b-tag__close`);await o.click(n),await new Promise(e=>setTimeout(e,300)),a(t.queryByTestId(`int-uncontrolled`)).toBeNull();let r=t.getByTestId(`int-controlled`).querySelector(`.b-tag__close`);await o.click(r),await new Promise(e=>setTimeout(e,300)),a(t.queryByTestId(`int-controlled`)).toBeNull();let i=t.getByTestId(`int-restore`);await o.click(i),await new Promise(e=>setTimeout(e,300)),a(t.getByTestId(`int-controlled`)).not.toBeNull();let c=t.getByTestId(`int-keyboard`).querySelector(`.b-tag__close`);c.focus(),a(document.activeElement).toBe(c),await o.keyboard(`{Enter}`),await new Promise(e=>setTimeout(e,300)),a(t.queryByTestId(`int-keyboard`)).toBeNull()}},b=[{token:`--b-tag-bg`,defaultValue:`oklch(96% 0.003 260)`,description:`Background of the default tag (AntD: defaultBg). Each preset color overrides this.`},{token:`--b-tag-color`,defaultValue:`oklch(32% 0.02 260)`,description:`Text color of the default tag (AntD: defaultColor). Each preset color overrides this.`},{token:`--b-tag-border-color`,defaultValue:`oklch(87% 0.007 260)`,description:`Border color of the tag.`},{token:`--b-tag-border-radius`,defaultValue:`4px`,description:`Corner radius of the tag.`},{token:`--b-tag-custom-color`,defaultValue:`initial`,description:"Seed color used when the consumer passes a custom hex/oklch via the `color` prop. Other tokens derive from it via color-mix."},{token:`--b-tag-font-size`,defaultValue:`12px`,description:`Base font size (sizes: 11px / 12px / 14px).`},{token:`--b-tag-line-height`,defaultValue:`20px`,description:`Line height (sizes: 16px / 20px / 26px).`},{token:`--b-tag-height`,defaultValue:`22px`,description:`Tag height (sizes: 18px / 22px / 28px).`},{token:`--b-tag-padding`,defaultValue:`0 7px`,description:`Horizontal padding (sizes: 0 5px / 0 7px / 0 10px).`},{token:`--b-tag-gap`,defaultValue:`4px`,description:`Gap between icon, text, and close button.`},{token:`--b-tag-close-size`,defaultValue:`12px`,description:`Size of the close icon (sizes: 10px / 12px / 14px).`},{token:`--b-tag-close-offset`,defaultValue:`3px`,description:`Horizontal offset of the close icon.`},{token:`--b-tag-close-opacity`,defaultValue:`0.45`,description:`Idle opacity of the close icon.`},{token:`--b-tag-close-hover-opacity`,defaultValue:`1`,description:`Hovered opacity of the close icon.`},{token:`--b-tag-transition-duration`,defaultValue:`200ms`,description:`Transition duration for color/background changes.`}],x={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-tag-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BTag:r},setup:()=>({tokens:b}),template:`
...
}`,...y.parameters?.docs?.source},description:{story:`Automated play function covering the main interaction flows.`,...y.parameters?.docs?.description}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  name: 'Design Tokens',
  parameters: {
    controls: {
      disable: true
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-tag-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...x.parameters?.docs?.source}}},S=[`Playground`,`Basic`,`PresetColors`,`CustomColors`,`Sizes`,`Variants`,`Closable`,`CustomCloseIcon`,`Accessibility`,`Theming`,`InteractionTests`,`DesignTokens`]}))();export{_ as Accessibility,u as Basic,h as Closable,g as CustomCloseIcon,f as CustomColors,x as DesignTokens,y as InteractionTests,l as Playground,d as PresetColors,p as Sizes,v as Theming,m as Variants,S as __namedExportsOrder,c as default};