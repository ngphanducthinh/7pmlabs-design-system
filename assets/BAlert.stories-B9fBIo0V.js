...
<BAlert type="error"   message="Error"   description="Something went wrong."             show-icon />
        `}}},render:()=>({components:{BAlert:o},template:`
    ...
    `})},m={parameters:{controls:{disable:!0},docs:{source:{code:`<BAlert type="warning" message="You can close this alert." :closable="true" :show-icon="true" />`}}},render:()=>({components:{BAlert:o},setup(){function e(){console.log(`close fired`)}function t(){console.log(`afterClose fired`)}return{onClose:e,onAfterClose:t}},template:`
      <BAlert
        type="warning"
      ...
      />
    `})},h={parameters:{layout:`fullscreen`,controls:{disable:!0},docs:{source:{code:`<BAlert type="info" message="Scheduled maintenance on Saturday 01:00–03:00 UTC." :banner="true" :show-icon="true" />`}}},render:()=>({components:{BAlert:o},template:`
      <BAlert
        type="info"
        ...
        :show-icon="true"
      />
    `})},g={parameters:{controls:{disable:!0},docs:{source:{code:`<BAlert type="error" message="Failed to save changes." action="Retry" :show-icon="true" />`}}},render:()=>({components:{BAlert:o},template:`
      <BAlert
        type="error"
...
<template>
  ...
  <BAlert v-model="visible" type="success" message="Controlled alert." :closable="true" :show-icon="true" />
        ...
        `}}},render:()=>({components:{BAlert:o},setup(){return{visible:t(!0)}},template:`
      <div style="display:flex;flex-direction:column;gap:1rem;">
    ...
    `})},v={name:`Accessibility (roles & keyboard)`,parameters:{controls:{disable:!0},docs:{description:{story:'Each alert type uses the correct ARIA live-region role. The close button is fully keyboard accessible (Tab → Enter / Space / Escape). Status icons carry `aria-hidden="true"` as they are decorative.'}}},render:()=>({components:{BAlert:o},template:`
      <div style="display:flex;flex-direction:column;gap:1rem;">
...
/>
    ...
    `})},b={name:`Interaction – close flow`,parameters:{controls:{disable:!0},docs:{description:{story:`Automated play function: clicks the close button and asserts the alert is removed.`}}},render:()=>({components:{BAlert:o},template:`
      <BAlert
        data-testid="alert"
        type="warning"
