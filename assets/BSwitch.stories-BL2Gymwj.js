import{n as e}from"./chunk-BneVvdWh.js";import{X as t,i as n}from"./iframe-CuxZAc4v.js";import{n as r,t as i}from"./BSwitch-CSCOnQpW.js";var a,o,s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{i(),n(),{expect:a,userEvent:o,waitFor:s,within:c}=__STORYBOOK_MODULE_TEST__,l={title:`Data Entry/Switch`,component:r,tags:[`autodocs`],argTypes:{modelValue:{control:`boolean`,description:`The checked state of the switch.`,table:{category:`Two-Way Binding Props`}},defaultChecked:{control:`boolean`,description:`Initial checked state for uncontrolled usage.`,table:{defaultValue:{summary:`false`}}},disabled:{control:`boolean`,description:`Whether the switch is disabled.`,table:{defaultValue:{summary:`false`}}},loading:{control:`boolean`,description:`Whether to show a loading spinner on the handle.`,table:{defaultValue:{summary:`false`}}},size:{control:`select`,options:[`default`,`small`],description:`Size of the switch.`,table:{defaultValue:{summary:`'default'`}}}},parameters:{docs:{description:{component:`<code>BSwitch</code> is a toggle control for switching between two states. It supports controlled (<code>v-model</code>) and uncontrolled usage, loading state, custom checked/unchecked content via slots, and full keyboard accessibility.<br><br>Use <code>role="switch"</code> with proper <code>aria-checked</code> state for screen readers.`}}}},u={args:{modelValue:!1,disabled:!1,loading:!1,size:`default`},render:e=>({components:{BSwitch:r},setup:()=>({args:e,value:t(e.modelValue)}),template:`
    ...
    `}),play:async({canvasElement:e})=>{let t=c(e).getByRole(`switch`);await a(t).toBeInTheDocument(),await a(t).toHaveAttribute(`aria-checked`,`false`),await o.click(t),await s(()=>{a(t).toHaveAttribute(`aria-checked`,`true`)})}},d={render:()=>({components:{BSwitch:r},setup:()=>({v1:t(!0),v2:t(!0)}),template:`
    ...
    `})},f={render:()=>({components:{BSwitch:r},setup:()=>({v1:t(!1),v2:t(!0)}),template:`
      <div style="padding: 40px; display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 12px;">
    ...
    `})},p={render:()=>({components:{BSwitch:r},setup:()=>({v1:t(!1),v2:t(!0)}),template:`
      <div style="padding: 40px; display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 12px;">
    ...
    `})},m={parameters:{a11y:{config:{rules:[{id:`color-contrast`,selector:`*:not(.b-switch__inner-checked):not(.b-switch__inner-unchecked)`}]}}},render:()=>({components:{BSwitch:r},setup:()=>({v1:t(!0),v2:t(!0)}),template:`
      <div style="padding: 40px; display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 12px;">
    ...
    `})},h={render:()=>({components:{BSwitch:r},setup:()=>({value:t(!1)}),template:`
      <div style="padding: 40px;">
    ...
    `}),play:async({canvasElement:e})=>{let t=c(e).getByRole(`switch`);await a(t).toHaveAttribute(`aria-label`,`Enable notifications`),await a(t).toHaveAttribute(`aria-checked`,`false`),await a(t).toHaveAttribute(`tabindex`,`0`),await a(t).toHaveAttribute(`type`,`button`),await o.tab(),await s(()=>{a(t).toHaveFocus()}),await o.keyboard(`{Enter}`),await s(()=>{a(t).toHaveAttribute(`aria-checked`,`true`)}),await o.keyboard(` `),await s(()=>{a(t).toHaveAttribute(`aria-checked`,`false`)})}},g={render:()=>({components:{BSwitch:r},setup:()=>({v1:t(!0),v2:t(!0),v3:t(!0)}),template:`
    ...
    `})},_={render:()=>({components:{BSwitch:r},setup:()=>({tokens:[{variable:`--b-switch-handle-bg`,default:`#fff`,description:`Background color of the switch handle`},{variable:`--b-switch-handle-shadow`,default:`0 2px 4px 0 rgba(0,35,11,0.2)`,description:`Box shadow of the switch handle`},{variable:`--b-switch-handle-size`,default:`18px`,description:`Width and height of the switch handle`},{variable:`--b-switch-track-height`,default:`22px`,description:`Height of the switch track`},{variable:`--b-switch-track-min-width`,default:`44px`,description:`Minimum width of the switch track`},{variable:`--b-switch-track-padding`,default:`2px`,description:`Padding between the handle and the track edge`},{variable:`--b-switch-track-bg`,default:`rgba(0, 0, 0, 0.25)`,description:`Background color of the track when unchecked`},{variable:`--b-switch-track-bg-checked`,default:`#1565d8`,description:`Background color of the track when checked`},{variable:`--b-switch-track-bg-disabled`,default:`rgba(0, 0, 0, 0.04)`,description:`Background color of the track when disabled`},{variable:`--b-switch-inner-max-margin`,default:`24px`,description:`Maximum margin for inner content area`},{variable:`--b-switch-inner-min-margin`,default:`9px`,description:`Minimum margin for inner content area`},{variable:`--b-switch-loading-color`,default:`#1565d8`,description:`Color of the loading spinner`}],value:t(!0)}),template:`
      <div style="padding: 40px;">
...
}`,..._.parameters?.docs?.source}}},v=[`Playground`,`Sizes`,`Disabled`,`Loading`,`WithText`,`Accessibility`,`Theming`,`DesignTokens`]}))();export{h as Accessibility,_ as DesignTokens,f as Disabled,p as Loading,u as Playground,d as Sizes,g as Theming,m as WithText,v as __namedExportsOrder,l as default};