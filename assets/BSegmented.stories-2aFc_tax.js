...
<BSegmented :options="opts" size="large" />`}}},render:()=>({components:{BSegmented:i},setup(){return{OBJECT_OPTIONS:u}},template:`
...
<BSegmented :options="[
  ...
  { label: 'Satellite', value: 'satellite' },
]" />`}}},render:()=>({components:{BSegmented:i},setup(){return{OBJECT_OPTIONS:u,partialOpts:[{label:`Map`,value:`map`},{label:`Transit`,value:`transit`,disabled:!0},{label:`Satellite`,value:`satellite`}]}},template:`
      <div style="padding: 2rem; display: flex; flex-direction: column; gap: 1.5rem; align-items: flex-start;">
        <div>
    ...
    `}),play:async({canvasElement:e})=>{let t=s(e),n=t.getByTestId(`all-disabled`);a(n.classList.contains(`b-segmented--disabled`)).toBe(!0),a(n.getAttribute(`aria-disabled`)).toBe(`true`);let r=t.getByTestId(`partial-disabled`).querySelectorAll(`.b-segmented__item`)[1];a(r.classList.contains(`b-segmented__item--disabled`)).toBe(!0),a(r.getAttribute(`aria-disabled`)).toBe(`true`)}},h={parameters:{controls:{disable:!0},docs:{source:{code:`<BSegmented :options="opts" block />`}}},render:()=>({components:{BSegmented:i},setup(){return{STRING_OPTIONS:l}},template:`
      <div style="padding: 2rem;">
...
</BSegmented>`}}},render:()=>({components:{BSegmented:i},setup(){return{value:t(`list`),iconBaseOpts:[{label:`List`,value:`list`},{label:`Grid`,value:`grid`},{label:`Kanban`,value:`kanban`}],iconMap:{list:`☰`,grid:`⊞`,kanban:`▣`}}},template:`
      <div style="padding: 2rem;">
...
</BSegmented>`}}},render:()=>({components:{BSegmented:i},setup(){return{value:t(`map`),OBJECT_OPTIONS:u}},template:`
      <div style="padding: 2rem;">
...
<p>Selected: {{ value }}</p>`}}},render:()=>({components:{BSegmented:i},setup(){return{value:t(`Weekly`),STRING_OPTIONS:l}},template:`
      <div style="padding: 2rem;">
    ...
    `}),play:async({canvasElement:e})=>{let t=s(e),n=t.getByTestId(`controlled`),r=t.getByTestId(`selected-display`);a(r.querySelector(`strong`)?.textContent).toBe(`Weekly`);let i=n.querySelectorAll(`.b-segmented__item`);await o.click(i[2]),a(r.querySelector(`strong`)?.textContent).toBe(`Monthly`),a(i[2].getAttribute(`aria-checked`)).toBe(`true`)}},y={name:`Accessibility (roles & keyboard)`,parameters:{controls:{disable:!0},docs:{description:{story:"Verifies ARIA roles, `aria-checked`, `aria-disabled` attributes, and keyboard navigation. Use <kbd>Tab</kbd> to focus the control, then <kbd>←</kbd><kbd>→</kbd> to move focus, <kbd>Enter</kbd> or <kbd>Space</kbd> to select."}}},render:()=>({components:{BSegmented:i},setup(){return{value:t(`Daily`),STRING_OPTIONS:l,partialDisabled:[{label:`Map`,value:`map`},{label:`Transit`,value:`transit`,disabled:!0},{label:`Satellite`,value:`satellite`}]}},template:`
      <div style="padding: 2rem; display: flex; flex-direction: column; gap: 1.5rem; align-items: flex-start;">
...
<BSegmented class="custom-segmented" :options="opts" />`}}},render:()=>({components:{BSegmented:i},setup(){return{OBJECT_OPTIONS:u}},template:`
      <div style="padding: 2rem; display: flex; flex-direction: column; gap: 1.5rem; align-items: flex-start;">
        <div>
    ...
    `})},x={name:`Interaction – selection & keyboard`,parameters:{controls:{disable:!0},docs:{description:{story:`Automated play function verifying click selection, keyboard navigation, and disabled guard.`}}},render:()=>({components:{BSegmented:i},setup(){return{value:t(`Daily`),mapValue:t(`map`),STRING_OPTIONS:l,partialOpts:[{label:`Map`,value:`map`},{label:`Transit`,value:`transit`},{label:`Satellite`,value:`satellite`,disabled:!0}]}},template:`
      <div style="padding: 2rem; display: flex; flex-direction: column; gap: 1.5rem; align-items: flex-start;">
...
}`,...x.parameters?.docs?.source},description:{story:`Automated interaction tests: selection, events, keyboard, disabled.`,...x.parameters?.docs?.description}}},S=[`Playground`,`Basic`,`Sizes`,`Disabled`,`Block`,`WithIcons`,`CustomLabel`,`Controlled`,`Accessibility`,`Theming`,`InteractionTests`]}))();export{y as Accessibility,f as Basic,h as Block,v as Controlled,_ as CustomLabel,m as Disabled,x as InteractionTests,d as Playground,p as Sizes,b as Theming,g as WithIcons,S as __namedExportsOrder,c as default};