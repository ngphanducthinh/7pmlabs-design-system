import{n as e}from"./chunk-BneVvdWh.js";import{K as t,i as n}from"./iframe-BtDITyas.js";import{$ as r,Q as i,Z as a,et as o,nt as s,t as c,tt as l}from"./components-_FfmWUAp.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{c(),s(),n(),{expect:u,userEvent:d,waitFor:f,within:p}=__STORYBOOK_MODULE_TEST__,m={title:`Data Entry/Cascader`,component:a,tags:[`autodocs`],argTypes:{modelValue:{control:`object`,description:`The selected value as an array path (e.g. ["zhejiang", "hangzhou", "xihu"]).`,table:{category:`Two-Way Binding Props`}},options:{control:`object`,description:`Hierarchical options data.`},placeholder:{control:`text`,description:`Input placeholder text.`,table:{defaultValue:{summary:`Please select`}}},disabled:{control:`boolean`,description:`Whether the cascader is disabled.`,table:{defaultValue:{summary:`false`}}},allowClear:{control:`boolean`,description:`Whether to show a clear button.`,table:{defaultValue:{summary:`true`}}},expandTrigger:{control:`select`,options:Object.values(i),description:`Expand child options on click or hover.`,table:{defaultValue:{summary:i.Click}}},placement:{control:`select`,options:Object.values(r),description:`Popup placement.`,table:{defaultValue:{summary:r.BottomLeft}}},size:{control:`select`,options:Object.values(o),description:`Size of the input.`,table:{defaultValue:{summary:o.Medium}}},changeOnSelect:{control:`boolean`,description:`Emit change on each level selection, not just leaf.`,table:{defaultValue:{summary:`false`}}},showSearch:{control:`boolean`,description:`Enable search filtering.`,table:{defaultValue:{summary:`false`}}},multiple:{control:`boolean`,description:`Enable multiple selection mode.`,table:{defaultValue:{summary:`false`}}},maxTagCount:{control:`number`,description:`Maximum tags to display in multiple mode.`},status:{control:`select`,options:[void 0,...Object.values(l)],description:`Validation status.`},notFoundContent:{control:`text`,description:`Content when no search match found.`,table:{defaultValue:{summary:`No data`}}}},parameters:{docs:{description:{component:`The <code>BCascader</code> component displays a cascade selection menu for selecting from a hierarchical data structure (e.g. province/city/district).<br><br>Supports search, multiple selection, keyboard navigation, hover expand, and custom field names. Uses the native HTML <code>popover</code> attribute and CSS Anchor Positioning.`}}}},h=[{value:`zhejiang`,label:`Zhejiang`,children:[{value:`hangzhou`,label:`Hangzhou`,children:[{value:`xihu`,label:`West Lake`},{value:`xiasha`,label:`Xiasha`}]},{value:`ningbo`,label:`Ningbo`,children:[{value:`dongqianlake`,label:`Dongqian Lake`}]}]},{value:`jiangsu`,label:`Jiangsu`,children:[{value:`nanjing`,label:`Nanjing`,children:[{value:`zhonghuamen`,label:`Zhong Hua Men`},{value:`xuanwuhu`,label:`Xuanwu Lake`}]},{value:`suzhou`,label:`Suzhou`,children:[{value:`zhuozhengyuan`,label:`Humble Administrator's Garden`},{value:`huqiushan`,label:`Tiger Hill`}]}]},{value:`guangdong`,label:`Guangdong`,children:[{value:`shenzhen`,label:`Shenzhen`,children:[{value:`nanshan`,label:`Nanshan`},{value:`futian`,label:`Futian`}]}]}],g=[{value:`zhejiang`,label:`Zhejiang`,children:[{value:`hangzhou`,label:`Hangzhou`,disabled:!0,children:[{value:`xihu`,label:`West Lake`}]},{value:`ningbo`,label:`Ningbo`,children:[{value:`dongqianlake`,label:`Dongqian Lake`}]}]},{value:`jiangsu`,label:`Jiangsu`,disabled:!0}],_={render:e=>({components:{BCascader:a},setup(){return{args:e,value:t([])}},template:`
    ...
    `}),args:{options:h,placeholder:`Please select`,allowClear:!0,size:o.Medium,expandTrigger:i.Click}},v={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
    ...
    `})},y={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
    ...
    `})},b={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
          :options="sampleOptions"
          v-model="value"
    ...
    `})},x={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
          :options="sampleOptions"
          v-model="value"
    ...
    `})},S={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
          :options="sampleOptions"
          v-model="value"
    ...
    `})},C={render:()=>({components:{BCascader:a},setup(){return{value:t([[`zhejiang`,`hangzhou`,`xihu`],[`jiangsu`,`nanjing`,`zhonghuamen`],[`guangdong`,`shenzhen`,`nanshan`]]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
          :options="sampleOptions"
          v-model="value"
    ...
    `})},w={render:()=>({components:{BCascader:a},setup(){return{value:t([]),disabledOptions:g}},template:`
      <div style="padding: 40px;">
        <BCascader
    ...
    `})},T={render:()=>({components:{BCascader:a},setup(){return{value:t([`zhejiang`,`hangzhou`,`xihu`]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
          :options="sampleOptions"
          v-model="value"
    ...
    `})},E={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px; display: flex; flex-direction: column; gap: 16px;">
    ...
    `})},D={render:()=>({components:{BCascader:a},setup(){return{value:t([]),customOptions:[{code:`us`,name:`United States`,items:[{code:`ca`,name:`California`,items:[{code:`sf`,name:`San Francisco`}]},{code:`ny`,name:`New York`,items:[{code:`nyc`,name:`New York City`}]}]},{code:`uk`,name:`United Kingdom`,items:[{code:`london`,name:`London`,items:[{code:`camden`,name:`Camden`}]}]}]}},template:`
      <div style="padding: 40px;">
        <BCascader
    ...
    `})},O={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
    ...
    `}),play:async({canvasElement:e})=>{let t=p(e).getByRole(`combobox`);u(t).toBeTruthy(),u(t.getAttribute(`aria-haspopup`)).toBe(`listbox`),u(t.getAttribute(`aria-expanded`)).toBe(`false`),await d.click(e.querySelector(`.b-cascader`)),await f(()=>{u(e.querySelectorAll(`[role="listbox"]`).length).toBeGreaterThan(0)});let n=e.querySelectorAll(`[role="option"]`);u(n.length).toBeGreaterThan(0);for(let e of n)u(e.getAttribute(`tabindex`)).not.toBeNull()}},k={render:()=>({components:{BCascader:a},setup(){return{value:t([`zhejiang`,`hangzhou`,`xihu`]),sampleOptions:h}},template:`
    ...
    `})},A={render:()=>({components:{BCascader:a},setup(){return{value:t([]),sampleOptions:h}},template:`
      <div style="padding: 40px;">
        <BCascader
          :options="sampleOptions"
          v-model="value"
