import{n as e}from"./chunk-BneVvdWh.js";import{X as t,i as n}from"./iframe-CT7ZgrLF.js";import{A as r,u as i}from"./types-CV_3xB-y.js";import{n as a,r as o,t as s}from"./types-DMAbnpXw.js";import{n as c,t as l}from"./BInput-C9npwM0F.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;e((()=>{l(),o(),r(),n(),{expect:u,userEvent:d,waitFor:f,within:p}=__STORYBOOK_MODULE_TEST__,m={title:`Data Entry/Input`,component:c,tags:[`autodocs`],argTypes:{modelValue:{control:`text`,description:`Current input value (v-model).`,table:{category:`Two-Way Binding Props`}},size:{control:`select`,options:Object.values(i),description:`Size of the input.`,table:{defaultValue:{summary:i.Medium}}},variant:{control:`select`,options:Object.values(a),description:`Visual variant.`,table:{defaultValue:{summary:a.Outlined}}},status:{control:`select`,options:[void 0,...Object.values(s)],description:`Validation status.`},type:{control:`text`,description:`HTML input type.`,table:{defaultValue:{summary:`text`}}},disabled:{control:`boolean`,description:`Whether the input is disabled.`,table:{defaultValue:{summary:`false`}}},readOnly:{control:`boolean`,description:`Whether the input is read-only.`,table:{defaultValue:{summary:`false`}}},placeholder:{control:`text`,description:`Placeholder text.`},maxLength:{control:`number`,description:`Maximum character length.`},allowClear:{control:`boolean`,description:`Show clear button.`,table:{defaultValue:{summary:`false`}}},showCount:{control:`boolean`,description:`Display character count.`,table:{defaultValue:{summary:`false`}}}},parameters:{docs:{description:{component:`<code>BInput</code> is a text input field supporting multiple variants, sizes, prefix/suffix slots, addons, clear button, character counting, password visibility toggle, and validation states.`}}}},h={args:{placeholder:`Enter text...`,size:`md`,variant:`outlined`,disabled:!1,allowClear:!0,showCount:!1},render:e=>({components:{BInput:c},setup:()=>({args:e,value:t(``)}),template:`
