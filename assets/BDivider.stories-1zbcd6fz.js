...
<BDivider class="my-divider">Custom Theme</BDivider>
    ...
    `}),play:async({canvasElement:e})=>{let t=e.querySelector(`[data-testid="plain-hr"]`);r(t).not.toBeNull(),r(t.tagName).toBe(`DIV`),r(t.getAttribute(`role`)).toBe(`separator`),r(t.classList.contains(`b-divider--solid`)).toBe(!0),r(t.classList.contains(`b-divider--size-large`)).toBe(!0);let n=e.querySelector(`[data-testid="with-text"]`);r(n).not.toBeNull(),r(n.tagName).toBe(`DIV`),r(n.classList.contains(`b-divider--with-text`)).toBe(!0),r(n.classList.contains(`b-divider--text-start`)).toBe(!0);let i=n.querySelector(`.b-divider__content`);r(i).not.toBeNull(),r(i.textContent).toBe(`Label`);let a=e.querySelector(`[data-testid="vertical"]`);r(a).not.toBeNull(),r(a.tagName).toBe(`SPAN`),r(a.classList.contains(`b-divider--vertical`)).toBe(!0),r(a.getAttribute(`aria-orientation`)).toBe(`vertical`)}},h=[{token:`--b-divider-orientation-margin`,defaultValue:`5%`,description:`Distance between text and edge when orientation is left/right (AntD: orientationMargin).`},{token:`--b-divider-text-padding-inline`,defaultValue:`1em`,description:`Horizontal padding around the text label (AntD: textPaddingInline).`},{token:`--b-divider-vertical-margin-inline`,defaultValue:`0.5rem`,description:`Horizontal margin around vertical dividers (AntD: verticalMarginInline).`},{token:`--b-divider-color`,defaultValue:`oklch(0% 0 0 / 6%)`,description:`Color of the divider line (AntD: colorSplit).`},{token:`--b-divider-line-width`,defaultValue:`1px`,description:`Thickness of the divider line.`},{token:`--b-divider-text-color`,defaultValue:`oklch(20% 0.005 260 / 88%)`,description:`Color of the text label.`},{token:`--b-divider-font-size`,defaultValue:`1rem`,description:`Font size of the text label.`},{token:`--b-divider-font-weight-text`,defaultValue:`500`,description:`Font weight of the text label.`},{token:`--b-divider-margin-block-small`,defaultValue:`0.5rem`,description:`Vertical margin for small horizontal dividers.`},{token:`--b-divider-margin-block-medium`,defaultValue:`1rem`,description:`Vertical margin for medium horizontal dividers.`},{token:`--b-divider-margin-block-large`,defaultValue:`1.5rem`,description:`Vertical margin for large horizontal dividers.`}],g={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-divider-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BDivider:t},setup:()=>({tokens:h}),template:`
...
for horizontal, horizontal-with-text, and vertical dividers.`,...m.parameters?.docs?.description}}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: 'Design Tokens',
  parameters: {
    controls: {
      disable: true
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-divider-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...g.parameters?.docs?.source}}},_=[`Playground`,`HorizontalVariants`,`WithText`,`PlainVsHeading`,`Sizes`,`Vertical`,`Accessibility`,`Theming`,`InteractionStructure`,`DesignTokens`]}))();export{f as Accessibility,g as DesignTokens,s as HorizontalVariants,m as InteractionStructure,l as PlainVsHeading,o as Playground,u as Sizes,p as Theming,d as Vertical,c as WithText,_ as __namedExportsOrder,a as default};