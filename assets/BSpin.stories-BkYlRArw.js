import{n as e}from"./chunk-BneVvdWh.js";import{K as t,i as n}from"./iframe-BMgVmRCG.js";import{A as r,C as i}from"./types-CV_3xB-y.js";import{b as a,t as o}from"./components-DBCIcu8v.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{o(),r(),n(),{expect:s,userEvent:c,waitFor:l,within:u}=__STORYBOOK_MODULE_TEST__,d={title:`Feedback/Spin`,component:a,tags:[`autodocs`],argTypes:{spinning:{control:`boolean`,description:`Whether the spinner is active.`,table:{defaultValue:{summary:`true`}}},size:{control:`select`,options:Object.values(i),description:`Size of the spinner indicator.`,table:{defaultValue:{summary:i.Default}}},tip:{control:`text`,description:`Descriptive text below the spinner.`},delay:{control:`number`,description:`Delay in ms before spinner shows (prevents flicker).`,table:{defaultValue:{summary:`0`}}},fullscreen:{control:`boolean`,description:`Display as a fullscreen overlay.`,table:{defaultValue:{summary:`false`}}}},parameters:{docs:{description:{component:`The <code>BSpin</code> component displays a loading indicator.<br><br>It supports three <strong>sizes</strong> (small, default, large), an optional <strong>tip</strong> text, a <strong>delay</strong> to prevent flicker, <strong>fullscreen</strong> overlay mode, and a <strong>nested</strong> mode that wraps content with a dimmed overlay while loading.<br>The spinner is accessible with <code>role="status"</code> and respects <code>prefers-reduced-motion</code>.`}}}},f={args:{spinning:!0,size:i.Default,tip:``,delay:0,fullscreen:!1},render:e=>({components:{BSpin:a},setup(){return{args:e}},template:`<BSpin v-bind="args" />`})},p={parameters:{controls:{disable:!0},docs:{source:{code:`
<BSpin size="small" />
<BSpin />
<BSpin size="large" />
