...
<BCard title="Default Card" extra="More">
  <p>Card content</p>
        ...
        `}}},render:()=>({components:{BCard:o},template:`
...
<BCard>
  ...
  <template #actions>
    ...
    <button>Share</button>
        ...
        `}}},render:()=>({components:{BCard:o,BCardMeta:i},template:`
      <div style="display:flex;gap:1.5rem;flex-wrap:wrap;">
...
>
  <p>Content for {{ activeTab }}</p>
        ...
        `}}},render:()=>({components:{BCard:o},setup(){return{tabList:[{key:`article`,tab:`Article`},{key:`app`,tab:`App`},{key:`project`,tab:`Project`}]}},template:`
...
<BCard title="Grid Card">
  <BCardGrid v-for="i in 6" :key="i" hoverable>
    Content {{ i }}
        ...
        `}}},render:()=>({components:{BCard:o,BCardGrid:a},template:`
...
<BCard class="custom-card" title="Custom Theme">
  <p>Themed card content</p>
    ...
    `})},S={name:`Interaction – tabs & keyboard`,parameters:{controls:{disable:!0},docs:{description:{story:`Automated play function: verifies tab switching, keyboard navigation, and focus management.`}}},render:()=>({components:{BCard:o},setup(){return{tabList:[{key:`first`,tab:`First`},{key:`second`,tab:`Second`},{key:`third`,tab:`Third`}]}},template:`
      <div style="max-width:500px;">
        <BCard
    ...
    `}),play:async({canvasElement:e})=>{let t=u(e).getByTestId(`interact-card`).querySelectorAll(`[role="tab"]`);c(t[0].classList.contains(`b-card__tab--active`)).toBe(!0),c(t[0].getAttribute(`aria-selected`)).toBe(`true`),await l.click(t[1]),c(t[1].classList.contains(`b-card__tab--active`)).toBe(!0),c(t[1].getAttribute(`aria-selected`)).toBe(`true`),c(t[0].classList.contains(`b-card__tab--active`)).toBe(!1),await l.click(t[1]),await l.keyboard(`{ArrowRight}`),c(t[2].classList.contains(`b-card__tab--active`)).toBe(!0),await l.keyboard(`{ArrowRight}`),c(t[0].classList.contains(`b-card__tab--active`)).toBe(!0),await l.keyboard(`{End}`),c(t[2].classList.contains(`b-card__tab--active`)).toBe(!0),await l.keyboard(`{Home}`),c(t[0].classList.contains(`b-card__tab--active`)).toBe(!0)}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Card Title',
    extra: 'More',
    bordered: true,
...
}`,...S.parameters?.docs?.source},description:{story:`Automated interaction tests: tab switching, keyboard nav, loading.`,...S.parameters?.docs?.description}}},C=[`Playground`,`BasicCard`,`Hoverable`,`Loading`,`InnerAndSizes`,`CoverAndMeta`,`WithTabs`,`GridLayout`,`Accessibility`,`Theming`,`InteractionTests`]}))();export{b as Accessibility,p as BasicCard,_ as CoverAndMeta,y as GridLayout,m as Hoverable,g as InnerAndSizes,S as InteractionTests,h as Loading,f as Playground,x as Theming,v as WithTabs,C as __namedExportsOrder,d as default};