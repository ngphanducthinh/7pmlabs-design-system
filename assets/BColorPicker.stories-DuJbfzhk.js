import{n as e}from"./chunk-BneVvdWh.js";import{K as t,i as n}from"./iframe-BtDITyas.js";import{G as r,J as i,K as a,U as o,W as s,q as c,t as l}from"./components-_FfmWUAp.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{l(),i(),n(),{expect:u,userEvent:d,waitFor:f,within:p}=__STORYBOOK_MODULE_TEST__,m={title:`Data Entry/ColorPicker`,component:o,tags:[`autodocs`],argTypes:{modelValue:{control:`color`,description:`Current color value (v-model).`,table:{category:`Two-Way Binding Props`}},open:{control:`boolean`,description:`Controlled open state (v-model:open).`,table:{category:`Two-Way Binding Props`}},defaultValue:{control:`color`,description:`Default color when uncontrolled.`,table:{defaultValue:{summary:`#1677ff`}}},disabled:{control:`boolean`,description:`Whether the picker is disabled.`,table:{defaultValue:{summary:`false`}}},size:{control:`select`,options:Object.values(a),description:`Size of the trigger.`,table:{defaultValue:{summary:a.Medium}}},trigger:{control:`select`,options:Object.values(c),description:`How the popup is triggered.`,table:{defaultValue:{summary:c.Click}}},placement:{control:`select`,options:Object.values(r),description:`Popup placement.`,table:{defaultValue:{summary:r.BottomLeft}}},format:{control:`select`,options:Object.values(s),description:`Controlled color format.`},defaultFormat:{control:`select`,options:Object.values(s),description:`Default color format.`,table:{defaultValue:{summary:s.Hex}}},disabledAlpha:{control:`boolean`,description:`Disable the alpha channel slider.`,table:{defaultValue:{summary:`false`}}},disabledFormat:{control:`boolean`,description:`Disable format switching.`,table:{defaultValue:{summary:`false`}}},showText:{control:`boolean`,description:`Show color value text next to swatch.`,table:{defaultValue:{summary:`false`}}},allowClear:{control:`boolean`,description:`Allow clearing the selected color.`,table:{defaultValue:{summary:`false`}}},arrow:{control:`boolean`,description:`Whether the popup has an arrow.`,table:{defaultValue:{summary:`true`}}},destroyOnHidden:{control:`boolean`,description:`Destroy popup DOM when closed.`,table:{defaultValue:{summary:`false`}}}},parameters:{docs:{description:{component:`The <code>BColorPicker</code> component provides a rich color selection interface with saturation panel, hue/alpha sliders, format switching, and preset colors.<br><br>Supports hex, RGB, HSL, and HSB formats. Full keyboard and screen-reader accessible.`}}}},h={args:{defaultValue:`#1677ff`,disabled:!1,size:`md`,trigger:`click`,placement:`bottom-left`,defaultFormat:`hex`,disabledAlpha:!1,disabledFormat:!1,showText:!1,allowClear:!1,arrow:!0,destroyOnHidden:!1},render:e=>({components:{BColorPicker:o},setup(){return{args:e,color:t(e.defaultValue)}},template:`
    ...
    `})},g={render:()=>({components:{BColorPicker:o},template:`
    ...
    `})},_={render:()=>({components:{BColorPicker:o},template:`
      <div style="padding: 40px 40px 300px;">
        <BColorPicker default-value="#1677ff" :show-text="true" />
      </div>
    `})},v={render:()=>({components:{BColorPicker:o},setup(){return{presets:[{label:`Recommended`,colors:[`#F5222D`,`#FA8C16`,`#FADB14`,`#8BBB11`,`#52C41A`,`#13A8A8`,`#1677FF`,`#2F54EB`,`#722ED1`,`#EB2F96`]},{label:`Recent`,colors:[`#F5222D`,`#1677FF`,`#52C41A`]}]}},template:`
      <div style="padding: 40px 40px 300px;">
        <BColorPicker default-value="#1677ff" :presets="presets" />
      </div>
    `})},y={render:()=>({components:{BColorPicker:o},template:`
      <div style="padding: 40px 40px 300px;">
        <BColorPicker default-value="#1677ff" disabled />
      </div>
    `})},b={render:()=>({components:{BColorPicker:o},setup(){return{hexColor:t(`#1677ff`),rgbColor:t(`#52c41a`),hslColor:t(`#faad14`)}},template:`
    ...
    `})},x={render:()=>({components:{BColorPicker:o},template:`
      <div style="padding: 40px 40px 300px;">
        <BColorPicker default-value="#1677ff" allow-clear :show-text="true" />
      </div>
    `})},S={render:()=>({components:{BColorPicker:o},setup(){let e=t(`#1677ff`),n=[];return{color:e,events:n,onChange:e=>{n.push(`change: ${e}`)},onComplete:e=>{n.push(`complete: ${e}`)}}},template:`
      <div style="padding: 40px 40px 300px;">
        <BColorPicker
          v-model="color"
          :show-text="true"
    ...
    `})},C={render:()=>({components:{BColorPicker:o},template:`
