import{n as e}from"./chunk-BneVvdWh.js";import{O as t,X as n,i as r}from"./iframe-CkqcGmpM.js";import{C as i,t as a}from"./components-CTy29wV5.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{a(),r(),{expect:o,userEvent:s,within:c}=__STORYBOOK_MODULE_TEST__,l=[{key:`1`,name:`Alice Johnson`,age:32,address:`10 Downing St, London`,status:`active`},{key:`2`,name:`Bob Smith`,age:42,address:`221B Baker St, London`,status:`active`},{key:`3`,name:`Carol White`,age:28,address:`4 Privet Drive, Surrey`,status:`inactive`},{key:`4`,name:`Dave Brown`,age:55,address:`12 Grimmauld Place, London`,status:`active`},{key:`5`,name:`Eve Green`,age:19,address:`1 Railway Cuttings, East Cheam`,status:`inactive`}],u=[{title:`Name`,dataIndex:`name`,key:`name`},{title:`Age`,dataIndex:`age`,key:`age`,align:`right`},{title:`Address`,dataIndex:`address`,key:`address`},{title:`Status`,dataIndex:`status`,key:`status`}],d=Array.from({length:46},(e,t)=>({key:String(t+1),name:`User ${t+1}`,age:18+t%50,address:`${t+1} Fake Street`,status:t%3==0?`inactive`:`active`})),f={title:`Data Display/Table`,component:i,tags:[`autodocs`],argTypes:{dataSource:{control:`object`,description:`Array of data records to display.`,table:{category:`Props`}},columns:{control:`object`,description:`Column definitions.`,table:{category:`Props`}},size:{control:`select`,options:[`default`,`middle`,`small`],description:`Table density.`,table:{defaultValue:{summary:`default`},category:`Props`}},bordered:{control:`boolean`,description:`Show outer border and column separators.`,table:{defaultValue:{summary:`false`},category:`Props`}},loading:{control:`boolean`,description:`Show loading overlay.`,table:{defaultValue:{summary:`false`},category:`Props`}},showHeader:{control:`boolean`,description:`Show table header.`,table:{defaultValue:{summary:`true`},category:`Props`}},sticky:{control:`boolean`,description:`Make the table header sticky.`,table:{defaultValue:{summary:`false`},category:`Props`}},caption:{control:`text`,description:`Accessible table caption.`,table:{category:`Props`}},rowKey:{control:`text`,description:`Row key field name or extractor function.`,table:{defaultValue:{summary:`key`},category:`Props`}}},parameters:{docs:{description:{component:`The <code>BTable</code> component displays structured tabular data.<br><br>Supports <strong>sorting</strong>, <strong>filtering</strong>, <strong>row selection</strong>, <strong>expandable rows</strong>, <strong>pagination</strong>, <strong>column groups</strong>, sticky header, bordered mode, and three sizes.<br>Theming via <code>--b-table-*</code> CSS custom properties. Respects <code>prefers-reduced-motion</code> and <code>[data-prefers-color='dark']</code>.`}}}},p={args:{dataSource:l,columns:u,size:`default`,bordered:!1,loading:!1,showHeader:!0,sticky:!1,caption:``,rowKey:`key`},render:e=>({components:{BTable:i},setup(){return{args:e}},template:`
...
/>`}}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:u}},template:`
    ...
    `})},g={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l.slice(0,3),columns:u}},template:`
      <div style="padding: 2rem; display: flex; flex-direction: column; gap: 2rem;">
        <div>
    ...
    `})},_={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{loading:n(!0),data:n([]),columns:u}},template:`
      <div style="padding: 2rem;">
        <BTable data-testid="loading-table" :dataSource="data" :columns="columns" :loading="loading" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`loading-table`).querySelector(`.b-table__loading-overlay`);o(t).toBeTruthy(),o(t.getAttribute(`role`)).toBe(`status`),o(t.getAttribute(`aria-live`)).toBe(`polite`)}},v={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:[],columns:u}},template:`
      <div style="padding: 2rem;">
        <BTable data-testid="empty-table" :dataSource="data" :columns="columns" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`empty-table`);o(t.querySelector(`.b-table__empty`)).toBeTruthy(),o(t.querySelector(`.b-table__empty-text`)?.textContent?.trim()).toBe(`No data`)}},y={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:[{title:`Name`,dataIndex:`name`,key:`name`,sorter:!0},{title:`Age`,dataIndex:`age`,key:`age`,sorter:(e,t)=>e.age-t.age,align:`right`},{title:`Address`,dataIndex:`address`,key:`address`}]}},template:`
      <div style="padding: 2rem;">
        <BTable data-testid="sort-table" :dataSource="data" :columns="columns" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`sort-table`).querySelectorAll(`.b-table__th`);o(t[0].getAttribute(`aria-sort`)).toBe(`none`),o(t[1].getAttribute(`aria-sort`)).toBe(`none`);let n=t[1].querySelector(`.b-table__sorter`);o(n).toBeTruthy(),await s.click(n),o(t[1].getAttribute(`aria-sort`)).toBe(`ascending`),await s.click(n),o(t[1].getAttribute(`aria-sort`)).toBe(`descending`),await s.click(n),o(t[1].getAttribute(`aria-sort`)).toBe(`none`)}},b={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:[{title:`Name`,dataIndex:`name`,key:`name`},{title:`Status`,dataIndex:`status`,key:`status`,filters:[{text:`Active`,value:`active`},{text:`Inactive`,value:`inactive`}],filterMultiple:!1}]}},template:`
      <div style="padding: 2rem;">
        <BTable data-testid="filter-table" :dataSource="data" :columns="columns" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`filter-table`),n=t.querySelector(`.b-table__filter-btn`);o(n).toBeTruthy(),o(n.getAttribute(`aria-expanded`)).toBe(`false`),await s.click(n),o(n.getAttribute(`aria-expanded`)).toBe(`true`);let r=t.querySelector(`.b-table__filter-dropdown`);o(r).toBeTruthy(),o(r.getAttribute(`role`)).toBe(`dialog`);let i=t.querySelectorAll(`.b-table__filter-item-input`);o(i.length).toBe(2),await s.click(i[0]);let a=t.querySelector(`.b-table__filter-confirm`);await s.click(a),o(t.querySelector(`.b-table__filter-dropdown`)).toBeNull(),o(t.querySelectorAll(`.b-table__tr--data`).length).toBeGreaterThan(0)}},x={name:`Row Selection - Checkbox`,parameters:{controls:{disable:!0},a11y:{options:{rules:{"color-contrast":{enabled:!1}}}}},render:()=>({components:{BTable:i},setup(){let e=n([]);return{data:l,columns:u,rowSelection:{type:`checkbox`,onChange:t=>{e.value=t}},selectedKeys:e}},template:`
    ...
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`selection-table`);o(t.querySelector(`.b-table__th--selection .b-table__checkbox`)).toBeTruthy();let n=t.querySelectorAll(`.b-table__td--selection .b-table__checkbox`);o(n.length).toBe(l.length),await s.click(n[0]);let r=t.querySelectorAll(`.b-table__tr--data`)[0];o(r.classList.contains(`b-table__tr--selected`)).toBe(!0)}},S={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:u.slice(0,3),expandable:{expandedRowRender:e=>t(`div`,{style:`padding:8px 16px;color:#595959;`},`Notes for ${e.name}: -`),rowExpandable:()=>!0}}},template:`
      <div style="padding: 2rem;">
        <BTable data-testid="expand-table" :dataSource="data" :columns="columns" :expandable="expandable" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`expand-table`),n=t.querySelectorAll(`.b-table__expand-btn`);o(n.length).toBeGreaterThan(0),o(n[0].getAttribute(`aria-expanded`)).toBe(`false`),await s.click(n[0]),o(n[0].getAttribute(`aria-expanded`)).toBe(`true`),o(t.querySelector(`.b-table__tr--expanded-content`)).toBeTruthy()}},C={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:d,columns:u,pagination:{pageSize:10,showSizeChanger:!0,showTotal:e=>`Total ${e} items`}}},template:`
      <div style="padding: 2rem;">
        <BTable data-testid="paginated-table" :dataSource="data" :columns="columns" :pagination="pagination" />
      </div>
    `}),play:async({canvasElement:e})=>{let t=c(e).getByTestId(`paginated-table`);o(t.querySelectorAll(`.b-table__tr--data`).length).toBe(10);let n=t.querySelector(`.b-table__pagination`);o(n).toBeTruthy(),o(n.getAttribute(`role`)).toBe(`navigation`);let r=t.querySelectorAll(`.b-table__page-btn`),i=r[r.length-1];await s.click(i),o(t.querySelector(`.b-table__page-btn--active`)?.textContent?.trim()).toBe(`2`)}},w={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:[{title:`Identity`,children:[{title:`Name`,dataIndex:`name`,key:`name`},{title:`Age`,dataIndex:`age`,key:`age`,align:`right`}]},{title:`Address`,dataIndex:`address`,key:`address`},{title:`Status`,dataIndex:`status`,key:`status`}]}},template:`
      <div style="padding: 2rem;">
        <BTable :dataSource="data" :columns="columns" :bordered="true" />
      </div>
    `})},T={name:`Scroll & Fixed Columns`,parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l,wideColumns:[{title:`Name`,dataIndex:`name`,key:`name`,fixed:`left`,width:150},{title:`Age`,dataIndex:`age`,key:`age`,width:200},{title:`Address`,dataIndex:`address`,key:`address`,width:400},{title:`Status`,dataIndex:`status`,key:`status`,width:200}],scroll:{x:900,y:200}}},template:`
      <div style="padding: 2rem; max-width: 600px;">
        <BTable :dataSource="data" :columns="wideColumns" :scroll="scroll" :bordered="true" />
      </div>
    `})},E={parameters:{controls:{disable:!0},a11y:{options:{rules:{"color-contrast":{enabled:!1}}}}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:[{title:`Name`,dataIndex:`name`,key:`name`},{title:`Age`,dataIndex:`age`,key:`age`,align:`right`},{title:`Status`,dataIndex:`status`,key:`status`,customRender:({value:e})=>{let n=e===`active`;return t(`span`,{style:`display:inline-block;padding:2px 10px;border-radius:20px;font-size:12px;font-weight:600;background:${n?`#e6f4ff`:`#fff1f0`};color:${n?`#0958d9`:`#cf1322`}`},n?`Active`:`Inactive`)}},{title:`Action`,key:`action`}]}},template:`
      <div style="padding: 2rem;">
    ...
    `})},D={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:d.slice(0,20),columns:u,scroll:{y:240}}},template:`
      <div style="padding: 2rem;">
        <BTable :dataSource="data" :columns="columns" :scroll="scroll" :sticky="true" />
      </div>
    `})},O={parameters:{controls:{disable:!0}},render:()=>({components:{BTable:i},setup(){return{data:l.slice(0,3),columns:u}},template:`
      <div style="padding: 2rem;">
        <BTable :dataSource="data" :columns="columns" :bordered="true">
          <template #title>
...
/>`}}},render:()=>({components:{BTable:i},setup(){return{data:l,columns:u}},template:`
    ...
    `})},j=[{token:`--b-table-bg`,defaultValue:`oklch(100% 0 0)`,description:`Background color of the table.`},{token:`--b-table-color`,defaultValue:`oklch(20% 0.02 260)`,description:`Default text color of cells.`},{token:`--b-table-border-color`,defaultValue:`oklch(88% 0.01 260)`,description:`Border color of the table (AntD: borderColor).`},{token:`--b-table-cell-padding`,defaultValue:`12px 16px`,description:`Cell padding at default size (AntD: cellPaddingBlock + cellPaddingInline).`},{token:`--b-table-cell-padding-middle`,defaultValue:`8px 16px`,description:`Cell padding at middle size (AntD: cellPaddingBlockMD).`},{token:`--b-table-cell-padding-small`,defaultValue:`4px 8px`,description:`Cell padding at small size (AntD: cellPaddingBlockSM).`},{token:`--b-table-font-size`,defaultValue:`14px`,description:`Font size of table cells (AntD: cellFontSize).`},{token:`--b-table-header-bg`,defaultValue:`oklch(97% 0.005 260)`,description:`Background of the table header (AntD: headerBg).`},{token:`--b-table-header-color`,defaultValue:`oklch(30% 0.02 260)`,description:`Color of header text (AntD: headerColor).`},{token:`--b-table-footer-bg`,defaultValue:`oklch(97% 0.005 260)`,description:`Background of the footer (AntD: footerBg).`},{token:`--b-table-row-hover-bg`,defaultValue:`oklch(96% 0.01 260)`,description:`Background of a hovered row (AntD: rowHoverBg).`},{token:`--b-table-row-selected-bg`,defaultValue:`oklch(94% 0.03 262)`,description:`Background of a selected row (AntD: rowSelectedBg).`},{token:`--b-table-row-expanded-bg`,defaultValue:`oklch(98% 0.005 260)`,description:`Background of an expanded row (AntD: rowExpandedBg).`},{token:`--b-table-filter-dropdown-bg`,defaultValue:`oklch(100% 0 0)`,description:`Background of the filter dropdown (AntD: filterDropdownBg).`},{token:`--b-table-border-radius`,defaultValue:`8px`,description:`Outer corner radius.`},{token:`--b-table-empty-color`,defaultValue:`oklch(48% 0.01 260)`,description:`Color of empty-state text.`},{token:`--b-table-checkbox-border`,defaultValue:`1px solid oklch(75% 0.01 260)`,description:`Border of selection checkboxes.`},{token:`--b-table-checkbox-checked-bg`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Background of a checked selection checkbox.`},{token:`--b-table-checkbox-checked-border`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Border of a checked selection checkbox.`},{token:`--b-table-checkbox-radius`,defaultValue:`4px`,description:`Corner radius of the selection checkbox.`},{token:`--b-table-checkbox-size`,defaultValue:`16px`,description:`Size of the selection checkbox.`},{token:`--b-table-expand-icon-color`,defaultValue:`oklch(45% 0.02 260)`,description:`Color of the row-expand chevron.`},{token:`--b-table-expand-icon-hover-color`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Hover color of the row-expand chevron.`},{token:`--b-table-expand-icon-size`,defaultValue:`17px`,description:`Size of the expand chevron.`},{token:`--b-table-filter-active-color`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Color of the filter button when a filter is active.`},{token:`--b-table-filter-dropdown-shadow`,defaultValue:`0 6px 16px oklch(0% 0 0 / 8%), 0 3px 6px oklch(0% 0 0 / 4%)`,description:`Box shadow for the filter dropdown.`},{token:`--b-table-loading-overlay-bg`,defaultValue:`oklch(100% 0 0)`,description:`Background of the loading overlay.`},{token:`--b-table-pagination-btn-active-bg`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Background of the active pagination button.`},{token:`--b-table-pagination-btn-active-color`,defaultValue:`oklch(100% 0 0)`,description:`Text color of the active pagination button.`},{token:`--b-table-pagination-btn-border`,defaultValue:`1px solid oklch(88% 0.01 260)`,description:`Border of pagination buttons.`},{token:`--b-table-pagination-btn-hover-bg`,defaultValue:`oklch(95% 0.01 262)`,description:`Hover background of pagination buttons.`},{token:`--b-table-pagination-btn-radius`,defaultValue:`6px`,description:`Corner radius of pagination buttons.`},{token:`--b-table-pagination-btn-size`,defaultValue:`32px`,description:`Size of pagination buttons.`},{token:`--b-table-pagination-color`,defaultValue:`oklch(30% 0.02 260)`,description:`Default text color of pagination.`},{token:`--b-table-sorter-color`,defaultValue:`oklch(65% 0.01 260)`,description:`Color of inactive sort arrows.`},{token:`--b-table-sorter-active-color`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Color of the active sort arrow.`},{token:`--b-table-spin-color`,defaultValue:`oklch(54.6% 0.245 262.881)`,description:`Color of the loading spinner.`},{token:`--b-table-spin-size`,defaultValue:`32px`,description:`Size of the loading spinner.`},{token:`--b-table-sticky-z-index`,defaultValue:`2`,description:`z-index of sticky table headers/columns.`},{token:`--b-table-transition-duration`,defaultValue:`200ms`,description:`Transition duration for color/background changes.`}],M={name:`Design Tokens`,parameters:{controls:{disable:!0},docs:{description:{story:`Reference table of every <code>--b-table-*</code> CSS custom property consumers can override to retheme the component.`}}},render:()=>({components:{BTable:i},setup:()=>({tokens:j,data:[{id:1,name:`Apple`,qty:12},{id:2,name:`Banana`,qty:7}],columns:[{key:`name`,dataIndex:`name`,title:`Name`},{key:`qty`,dataIndex:`qty`,title:`Qty`}]}),template:`
...
}`,...A.parameters?.docs?.source},description:{story:"Override `--b-table-*` CSS custom properties to brand the table.",...A.parameters?.docs?.description}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  name: 'Design Tokens',
  parameters: {
    controls: {
      disable: true
    ...
    docs: {
      description: {
        story: 'Reference table of every <code>--b-table-*</code> CSS custom property ' + 'consumers can override to retheme the component.'
      }
    }
  },
  render: () => ({
...
}`,...M.parameters?.docs?.source}}},N=[`Playground`,`Basic`,`Sizes`,`Bordered`,`Loading`,`Empty`,`Sorting`,`Filtering`,`RowSelectionCheckbox`,`ExpandableRows`,`Pagination`,`ColumnGroups`,`ScrollAndFixed`,`CustomCellRendering`,`StickyHeader`,`TitleAndFooter`,`Accessibility`,`Theming`,`DesignTokens`]}))();export{k as Accessibility,m as Basic,g as Bordered,w as ColumnGroups,E as CustomCellRendering,M as DesignTokens,v as Empty,S as ExpandableRows,b as Filtering,_ as Loading,C as Pagination,p as Playground,x as RowSelectionCheckbox,T as ScrollAndFixed,h as Sizes,y as Sorting,D as StickyHeader,A as Theming,O as TitleAndFooter,N as __namedExportsOrder,f as default};