import{n as e}from"./chunk-BneVvdWh.js";import{K as t,i as n}from"./iframe-BtDITyas.js";import{A as r,u as i}from"./types-CV_3xB-y.js";import{a,i as o,n as s,r as c,t as l}from"./BMentions-CTVlIKtr.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{l(),a(),r(),n(),{expect:u,userEvent:d,waitFor:f,within:p}=__STORYBOOK_MODULE_TEST__,m=[{label:`Alice`,value:`alice`},{label:`Bob`,value:`bob`},{label:`Charlie`,value:`charlie`},{label:`David`,value:`david`},{label:`Eve`,value:`eve`}],h={title:`Data Entry/Mentions`,component:s,tags:[`autodocs`],argTypes:{modelValue:{control:`text`,description:`Current textarea value (v-model).`,table:{category:`Two-Way Binding Props`}},size:{control:`select`,options:Object.values(i),description:`Size of the textarea.`,table:{defaultValue:{summary:i.Medium}}},variant:{control:`select`,options:Object.values(o),description:`Visual variant.`,table:{defaultValue:{summary:o.Outlined}}},status:{control:`select`,options:[void 0,...Object.values(c)],description:`Validation status.`},disabled:{control:`boolean`,description:`Whether the textarea is disabled.`,table:{defaultValue:{summary:`false`}}},readOnly:{control:`boolean`,description:`Whether the textarea is read-only.`,table:{defaultValue:{summary:`false`}}},placeholder:{control:`text`,description:`Placeholder text.`},allowClear:{control:`boolean`,description:`Show clear button.`,table:{defaultValue:{summary:`false`}}},rows:{control:`number`,description:`Number of visible text lines.`,table:{defaultValue:{summary:`3`}}},prefix:{control:`text`,description:`Trigger character(s) for mention lookup.`,table:{defaultValue:{summary:`"@"`}}},notFoundContent:{control:`text`,description:`Content shown when no results match.`,table:{defaultValue:{summary:`"Not Found"`}}}},parameters:{docs:{description:{component:`<code>BMentions</code> is a textarea component that triggers a suggestions dropdown when a configurable prefix character (e.g., <code>@</code>) is typed. Supports multiple prefix triggers, filtering, keyboard navigation, and accessibility.`}}}},g={args:{placeholder:`Type @ to mention someone...`,size:`md`,variant:`outlined`,disabled:!1,allowClear:!0,rows:3},render:e=>({components:{BMentions:s},setup:()=>({args:e,value:t(``),options:m}),template:`
    ...
    `})},_={render:()=>({components:{BMentions:s},setup:()=>({outlined:t(``),filled:t(``),borderless:t(``),options:m}),template:`
    ...
    `})},v={render:()=>({components:{BMentions:s},setup:()=>({value:t(``),options:m}),template:`
      <div style="padding: 40px; max-width: 400px;">
    ...
    `})},y={render:()=>({components:{BMentions:s},setup:()=>({err:t(``),warn:t(``),options:m}),template:`
      <div style="padding: 40px; display: flex; flex-direction: column; gap: 16px; max-width: 400px;">
        <div>
    ...
    `})},b={render:()=>({components:{BMentions:s},setup:()=>({options:m}),template:`
      <div style="padding: 40px; max-width: 400px;">
        <BMentions model-value="Hello @alice, this is disabled" disabled :options="options" />
      </div>
    `})},x={render:()=>({components:{BMentions:s},setup:()=>({value:t(``),options:m}),template:`
      <div style="padding: 40px; max-width: 400px;">
    ...
    `}),play:async({canvasElement:e})=>{let t=p(e),n=e.querySelector(`[role="combobox"]`),r=t.getByRole(`textbox`);u(n.getAttribute(`aria-haspopup`)).toBe(`listbox`),u(r.getAttribute(`aria-autocomplete`)).toBe(`list`),u(n.getAttribute(`aria-expanded`)).toBe(`false`),await d.type(r,`@`),await f(()=>{u(n.getAttribute(`aria-expanded`)).toBe(`true`)}),u(e.querySelector(`[role="listbox"]`)).toBeTruthy(),u(e.querySelectorAll(`[role="option"]`).length).toBeGreaterThan(0),await d.keyboard(`{ArrowDown}`),await f(()=>{u(r.getAttribute(`aria-activedescendant`)).toBeTruthy()}),await d.keyboard(`{Escape}`),await f(()=>{u(n.getAttribute(`aria-expanded`)).toBe(`false`)})}},S={render:()=>({components:{BMentions:s},setup:()=>({v1:t(``),v2:t(``),v3:t(``),options:m}),template:`
    ...
    `})},C={args:{placeholder:`Type @ to mention...`,allowClear:!0},render:e=>({components:{BMentions:s},setup:()=>({args:e,value:t(``),options:m}),template:`
      <div style="padding: 40px; max-width: 400px;">
        <BMentions v-bind="args" v-model="value" :options="options" />
        <p data-testid="current-value" style="margin-top: 12px; font-size: 12px; color: #666;">Value: "{{ value }}"</p>
      </div>
    `}),play:async({canvasElement:e})=>{let t=p(e),n=t.getByRole(`textbox`);await d.type(n,`Hello @`),await f(()=>{u(e.querySelectorAll(`[role="option"]`).length).toBeGreaterThan(0)}),await d.keyboard(`{Enter}`),await f(()=>{u(t.getByTestId(`current-value`).textContent).toContain(`@alice`)}),await d.type(n,` @b`),await f(()=>{u(e.querySelectorAll(`[role="option"]`).length).toBe(1)}),await d.keyboard(`{Enter}`),await f(()=>{u(t.getByTestId(`current-value`).textContent).toContain(`@bob`)})}},w={render:()=>({template:`
...
}`,...w.parameters?.docs?.source}}},T=[`Playground`,`Variants`,`MultiplePrefixes`,`Status`,`Disabled`,`Accessibility`,`Theming`,`InteractionTest`,`DesignTokens`]}))();export{x as Accessibility,w as DesignTokens,b as Disabled,C as InteractionTest,v as MultiplePrefixes,g as Playground,y as Status,S as Theming,_ as Variants,T as __namedExportsOrder,h as default};