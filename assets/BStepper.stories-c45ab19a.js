import{_ as B}from"./BButton-cba7b1f6.js";import{j as k,k as S,o as a,b as r,m as w,F as c,E as h,n as v,d as f,q as C,t as I,e as _}from"./vue.esm-bundler-109c6e5d.js";import"./Enums-5b02df9b.js";const L={class:"ds-flex"},V=["onClick"],l=k({__name:"BStepper",props:{headers:{},modelValue:{}},emits:["update:modelValue"],setup(d,{emit:o}){const e=d,m=o,p=S({get(){return e.modelValue},set(t){m("update:modelValue",t)}}),b=(t,u)=>{t.clickable&&(p.value=u)};return(t,u)=>(a(),r("div",null,[w("ul",L,[(a(!0),r(c,null,h(e.headers,(n,s)=>(a(),r("li",{key:n.text,class:v([{"ds-cursor-pointer":n.clickable,"ds-pointer-events-none ds-text-black/40":n.disabled,"ds-text-primary-t":s<p.value,"after:ds-border-1 after:content-[``] ds-flex-auto after:ds-mx-3 after:ds-h-1 after:ds-w-full after:ds-border-b after:ds-border-gray-200":s<t.headers.length-1},"ds-flex ds-items-center ds-whitespace-nowrap ds-text-sm ds-font-medium"]),onClick:$=>b(n,s)},[f(t.$slots,`step-header-${s}`,{text:n.text},()=>[C(I(n.text),1)])],10,V))),128))]),(a(!0),r(c,null,h(t.headers,(n,s)=>(a(),r("div",{key:n.text,class:v({"ds-hidden":p.value!==s})},[f(t.$slots,`step-content-${s}`)],2))),128))]))}});l.__docgenInfo={exportName:"default",displayName:"BStepper",description:"",tags:{},props:[{name:"headers",description:"Array of header objects.",required:!0,type:{name:"Array",elements:[{name:"BStepperHeader"}]}},{name:"modelValue",description:"Index of step.",required:!0,type:{name:"number"}}],events:[{name:"update:modelValue",type:{names:["number"]},description:"Update value, param: <code>value: number</code>",properties:[{type:{names:["mixed"]},description:"e"},{type:{names:["mixed"]},name:"value"}],tags:[{title:"param",type:{name:"mixed"},description:"e"},{title:"param",type:{name:"mixed"},name:"value"}]}],slots:[{name:"`step-header-${i}`",scoped:!0,bindings:[{name:"name",title:"binding"},{name:"text",title:"binding"}]},{name:"`step-content-${i}`",scoped:!0,bindings:[{name:"name",title:"binding"}]}],sourceFiles:["/home/runner/work/design-system/design-system/src/components/BStepper.vue"]};const T={title:"Components/Stepper",parameters:{docs:{description:{component:"The <code>BStepper</code> component displays progress through numbered steps."}}},component:l,tags:["autodocs"],args:{headers:[],modelValue:0}},i={render:d=>({components:{BStepper:l,BButton:B},setup(){const o=[{text:"Step 01"},{text:"Step 02"},{text:"Step 03"},{text:"Step 04"}],e=_(0);return{args:d,headers:o,step:e,previous:()=>{e.value!==0&&e.value--},next:()=>{e.value>=o.length-1||e.value++}}},template:`
  ...
  args: {}
}`,...(x=(g=i.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};const q=["Default"];export{i as Default,q as __namedExportsOrder,T as default};
